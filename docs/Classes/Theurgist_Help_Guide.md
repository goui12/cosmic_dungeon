...
- Choose this class when brewing stand access is required.
- Other incentives: TBD.
...
- Define full ability list.
- Define final intended party role.
- Define full player-facing incentives.
