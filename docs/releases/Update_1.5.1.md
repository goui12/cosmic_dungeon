...
- Implemented the already-parsed offer-level `requiredFactionTier` gate server-side. It now affects the unlocked-offer list sent to the client and is rechecked when purchase packets are handled.
