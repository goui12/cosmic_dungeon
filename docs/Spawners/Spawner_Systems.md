...
This HUD/showlabels work reads existing synchronized Cosmic Spawner block-entity and preset data only. It does not change Cosmic Spawner block-entity saved-data keys, Cosmic Spawner preset file structures, or the 1.5.0 to 1.5.1 data migration path; no spawner storage migration is required.
