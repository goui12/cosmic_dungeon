...
public final class SpawnerCommand {
    ...
    private static MutableComponent inertButton(String symbol) { return Component.literal("["+symbol+"]").withStyle(style -> style.withColor(ChatFormatting.GRAY).withHoverEvent(new HoverEvent.ShowText(Component.literal("Display-only for intrinsic drops")))); }
