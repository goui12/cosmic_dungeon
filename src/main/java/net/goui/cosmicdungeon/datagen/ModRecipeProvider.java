...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        shapeless(RecipeCategory.MISC, Items.EGG, 10)
                ...
                .save(output, "cosmicdungeon:chicken_block");

        // Magic block to 18 bismuth
    ...
    protected <T extends AbstractCookingRecipe> void oreCooking(RecipeOutput recipeOutput, RecipeSerializer<T> pCookingSerializer, AbstractCookingRecipe.Factory<T> factory,
        ...
        for(ItemLike itemlike : pIngredients) {
            SimpleCookingRecipeBuilder.generic(Ingredient.of(itemlike), pCategory, pResult, pExperience, pCookingTime, pCookingSerializer, factory).group(pGroup).unlockedBy(getHasName(itemlike), has(itemlike))
                    .save(recipeOutput, CosmicDungeonMod.MOD_ID + ":" + getItemName(pResult) + pRecipeName + "_" + getItemName(itemlike));
        }
    }
}