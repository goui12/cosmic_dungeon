...
public final class SpawnerPresetKeybindClient {
    ...
    private static final KeyMapping[] KEYBINDS = new KeyMapping[]{
            new KeyMapping(
                    "key.cosmicdungeon.spawner_preset_1",
                    InputConstants.Type.KEYSYM,
                    GLFW.GLFW_KEY_KP_1,
                    CosmicDungeonKeybindCategories.COSMIC_DUNGEON
            ),
            new KeyMapping(
                    "key.cosmicdungeon.spawner_preset_2",
                    InputConstants.Type.KEYSYM,
                    GLFW.GLFW_KEY_KP_2,
                    CosmicDungeonKeybindCategories.COSMIC_DUNGEON
            ),
            new KeyMapping(
                    "key.cosmicdungeon.spawner_preset_3",
                    InputConstants.Type.KEYSYM,
                    GLFW.GLFW_KEY_KP_3,
                    CosmicDungeonKeybindCategories.COSMIC_DUNGEON
            ),
            new KeyMapping(
                    "key.cosmicdungeon.spawner_preset_4",
                    InputConstants.Type.KEYSYM,
                    GLFW.GLFW_KEY_KP_4,
                    CosmicDungeonKeybindCategories.COSMIC_DUNGEON
            ),
            new KeyMapping(
                    "key.cosmicdungeon.spawner_preset_5",
                    InputConstants.Type.KEYSYM,
                    GLFW.GLFW_KEY_KP_5,
                    CosmicDungeonKeybindCategories.COSMIC_DUNGEON
            )
