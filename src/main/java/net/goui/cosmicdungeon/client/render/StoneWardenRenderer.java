...
public class StoneWardenRenderer
        extends MobRenderer<StoneWardenEntity, StoneWardenRenderState, StoneWardenModel> {

    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(CosmicDungeonMod.MOD_ID, "textures/entity/stone_warden.png");
    ...
    @Override
    public void extractRenderState(StoneWardenEntity entity,
                                   StoneWardenRenderState state,
                                   float partialTicks) {
