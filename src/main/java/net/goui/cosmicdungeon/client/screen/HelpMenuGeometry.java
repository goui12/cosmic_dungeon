...
record HelpMenuGeometry(int left, int top) {
    ...
    static final int CONTENT_W = 204;
    ...
    Rect upButton() { return new Rect(x(ARROW_X), y(UP_Y), HelpMenuAssets.ARROW_W, HelpMenuAssets.ARROW_H); }
    Rect downButton() { return new Rect(x(ARROW_X), y(DOWN_Y), HelpMenuAssets.ARROW_W, HelpMenuAssets.ARROW_H); }
