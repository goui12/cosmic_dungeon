...
public class RealmsPopups {
    ...
    public static PopupScreen customPopupScreen(Screen backgroundScreen, Component title, Component message, Consumer<PopupScreen> onContinue) {
        return new PopupScreen.Builder(backgroundScreen, title)
            .setMessage(message)
