...
public enum OctahedralGroup implements StringRepresentable {
    ...
    public Direction rotate(Direction direction) {
        if (this.rotatedDirections == null) {
            this.rotatedDirections = Util.makeEnumMap(Direction.class, p_392468_ -> {
                Direction.Axis direction$axis = p_392468_.getAxis();
                Direction.AxisDirection direction$axisdirection = p_392468_.getAxisDirection();
