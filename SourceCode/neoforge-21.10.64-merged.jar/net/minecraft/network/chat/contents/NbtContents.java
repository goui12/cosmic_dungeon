...
public class NbtContents implements ComponentContents {
    ...
    private NbtContents(String nbtPathPattern, @Nullable NbtPathArgument.NbtPath compiledNbtPath, boolean interpreting, Optional<Component> seperator, DataSource dataSource) {
    ...
    public MutableComponent resolve(@Nullable CommandSourceStack nbtPathPattern, @Nullable Entity entity, int recursionDepth) throws CommandSyntaxException {
        if (nbtPathPattern != null && this.compiledNbtPath != null) {
            Stream<Tag> stream = this.dataSource.getData(nbtPathPattern).flatMap(p_237417_ -> {
                try {
            ...
            if (this.interpreting) {
                ...
                return stream.flatMap(p_392622_ -> {
                    try {
                        ...
                        return Stream.of(ComponentUtils.updateForEntity(nbtPathPattern, component1, entity, recursionDepth));
