                ...
                p_367836_ -> {
                    ...
                    return CompletableFuture.allOf(
                        p_367836_.listElements()
                            ...
                            .map(
                                p_256105_ -> dumpValue(
                                    packoutput$pathprovider.json(p_256105_.key().location()), output, ops, conditionalCodec, Optional.of(new net.neoforged.neoforge.common.conditions.WithConditions<>(conditions.getOrDefault(p_256105_.key(), java.util.List.of()), p_256105_.value()))
                                )
                            )
                            .toArray(CompletableFuture[]::new)
                    );
