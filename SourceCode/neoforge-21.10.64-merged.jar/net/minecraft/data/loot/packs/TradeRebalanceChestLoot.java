...
public record TradeRebalanceChestLoot(HolderLookup.Provider registries) implements LootTableSubProvider {
    @Override
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> p_301981_) {
        ...
        p_301981_.accept(BuiltInLootTables.ANCIENT_CITY, this.ancientCityLootTable());
        p_301981_.accept(BuiltInLootTables.DESERT_PYRAMID, this.desertPyramidLootTable());
        p_301981_.accept(BuiltInLootTables.JUNGLE_TEMPLE, this.jungleTempleLootTable());
        p_301981_.accept(BuiltInLootTables.PILLAGER_OUTPOST, this.pillagerOutpostLootTable());
    }
