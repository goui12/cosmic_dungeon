    ...
    protected void generate() {
                                        ...
                                        p_251952_ -> SetItemCountFunction.setCount(ConstantValue.exactly(p_251952_.intValue()))
                                            .when(
                                                LootItemBlockStatePropertyCondition.hasBlockStateProperties(p_248918_)
                                                    .setProperties(
                                                        StatePropertiesPredicate.Builder.properties().hasProperty(SeaPickleBlock.PICKLES, p_251952_.intValue())
                                                    )
                                            )
                                    )
                            )
        ...
        this.add(
            ...
            p_250064_ -> LootTable.lootTable()
                .withPool(
                    LootPool.lootPool().add((LootPoolEntryContainer.Builder<?>)this.applyExplosionDecay(p_250064_, LootItem.lootTableItem(Items.COMPOSTER)))
                )
                .withPool(
                    LootPool.lootPool()
                                    ...
                                    p_251216_ -> p_251216_ == 8
                                        ...
                                        : LootItem.lootTableItem(Blocks.SNOW)
                                            ...
                                            .when(
                                                LootItemBlockStatePropertyCondition.hasBlockStateProperties(p_372570_)
                                                    .setProperties(
                                                        StatePropertiesPredicate.Builder.properties().hasProperty(SnowLayerBlock.LAYERS, p_251216_.intValue())
                                                    )
                                            )
                                )
                            )
        ...
        this.add(
            ...
            p_359404_ -> this.createSilkTouchDispatchTable(
                p_359404_,
                LootItem.lootTableItem(Items.AMETHYST_SHARD)
                    ...
                    .otherwise(
                        (LootPoolEntryContainer.Builder<?>)this.applyExplosionDecay(
                            p_359404_, LootItem.lootTableItem(Items.AMETHYST_SHARD).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F)))
                        )
                    )
            )
        );
