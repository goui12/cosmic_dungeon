...
public class BlockModelGenerators {
    ...
    public static BlockModelDefinitionGenerator createMirroredCubeGenerator(
        Block block, Variant p_variant, TextureMapping textureMapping, BiConsumer<ResourceLocation, ModelInstance> modelOutput
    ) {
    ...
    public BlockModelGenerators(
        Consumer<BlockModelDefinitionGenerator> blockStateOutput, ItemModelOutput itemModelOutput, BiConsumer<ResourceLocation, ModelInstance> modelOutput
    ) {
    ...
    public ResourceLocation createFlatItemModelWithBlockTextureAndOverlay(Item item, Block block, String suffix) {
        ...
        ResourceLocation resourcelocation1 = TextureMapping.getBlockTexture(block, suffix);
        return ModelTemplates.TWO_LAYERED_ITEM
            .create(ModelLocationUtils.getModelLocation(item), TextureMapping.layered(resourcelocation, resourcelocation1), this.modelOutput);
    }
    ...
    public void registerTwoLayerFlatItemModel(Block block, String suffix) {
        Item item = block.asItem();
        if (item != Items.AIR) {
            ResourceLocation resourcelocation = this.createFlatItemModelWithBlockTextureAndOverlay(item, block, suffix);
    ...
    public ResourceLocation createCreakingHeartModel(TexturedModel.Provider modelProvider, Block block, String suffix) {
        return modelProvider.updateTexture(
                p_392502_ -> p_392502_.put(TextureSlot.SIDE, TextureMapping.getBlockTexture(block, suffix))
    ...
    public void createOrientableTrapdoor(Block orientableTrapdoorBlock) {
        ...
        ResourceLocation resourcelocation = ModelTemplates.ORIENTABLE_TRAPDOOR_BOTTOM.create(orientableTrapdoorBlock, texturemapping, this.modelOutput);
        ...
        this.blockStateOutput.accept(createOrientableTrapdoor(orientableTrapdoorBlock, multivariant, plainVariant(resourcelocation), multivariant1));
        this.registerSimpleItemModel(orientableTrapdoorBlock, resourcelocation);
    }
    ...
    public void createTrapdoor(Block trapdoorBlock) {
        ...
        ResourceLocation resourcelocation = ModelTemplates.TRAPDOOR_BOTTOM.create(trapdoorBlock, texturemapping, this.modelOutput);
        ...
        this.blockStateOutput.accept(createTrapdoor(trapdoorBlock, multivariant, plainVariant(resourcelocation), multivariant1));
        this.registerSimpleItemModel(trapdoorBlock, resourcelocation);
    }
    ...
    public void createCrossBlock(Block block, BlockModelGenerators.PlantType plantType, Property<Integer> ageProperty, int... possibleValues) {
        if (ageProperty.getPossibleValues().size() != possibleValues.length) {
            ...
            this.blockStateOutput.accept(MultiVariantGenerator.dispatch(block).with(PropertyDispatch.initial(ageProperty).generate(p_408973_ -> {
                String s = "_stage" + possibleValues[p_408973_];
                ...
                MultiVariantGenerator.dispatch(unattachedStemBlock)
                    .with(
                        PropertyDispatch.initial(BlockStateProperties.AGE_7)
                            .generate(p_408957_ -> plainVariant(ModelTemplates.STEMS[p_408957_].create(unattachedStemBlock, texturemapping, this.modelOutput)))
                    )
            );
    }
    ...
    public void createPitcherCrop() {
        ...
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.dispatch(block)
                    .with(PropertyDispatch.initial(PitcherCropBlock.AGE, BlockStateProperties.DOUBLE_BLOCK_HALF).generate((p_408996_, p_408997_) -> {
                        return switch (p_408997_) {
                            case UPPER -> plainVariant(ModelLocationUtils.getModelLocation(block, "_top_stage_" + p_408996_));
                            case LOWER -> plainVariant(ModelLocationUtils.getModelLocation(block, "_bottom_stage_" + p_408996_));
                        };
                    }))
            );
    }
    ...
    public void createCommandBlock(Block commandBlock) {
        ...
        MultiVariant multivariant1 = plainVariant(
            this.createSuffixedVariant(
                commandBlock, "_conditional", ModelTemplates.COMMAND_BLOCK, p_387325_ -> texturemapping.copyAndUpdate(TextureSlot.SIDE, p_387325_)
            )
        );
        this.blockStateOutput
            .accept(
    ...
    public static MultiVariant createBambooModels(int age) {
        ...
        return new MultiVariant(
            WeightedList.of(
                IntStream.range(1, 5)
                    .mapToObj(p_408985_ -> new Weighted<>(plainModel(ModelLocationUtils.getModelLocation(Blocks.BAMBOO, p_408985_ + s)), 1))
    ...
    public void createBeeNest(Block beeNestBlock, Function<Block, TextureMapping> textureMappingGetter) {
        ...
        ResourceLocation resourcelocation = ModelTemplates.CUBE_ORIENTABLE_TOP_BOTTOM.createWithSuffix(beeNestBlock, "_empty", texturemapping, this.modelOutput);
                                        ...
                                        return plainVariant(
                                            int2objectmap.computeIfAbsent(
                                                ...
                                                p_387308_ -> this.createSuffixedVariant(
                                                    cropBlock, "_stage" + p_387308_, ModelTemplates.CROP, TextureMapping::crop
                                                )
                                            )
                                        );
                                    }
    ...
    public void createFurnace(Block furnaceBlock, TexturedModel.Provider modelProvider) {
        ...
        ResourceLocation resourcelocation = TextureMapping.getBlockTexture(furnaceBlock, "_front_on");
        MultiVariant multivariant1 = plainVariant(
                ...
                MultiVariantGenerator.dispatch(Blocks.MANGROVE_PROPAGULE)
                    .with(
                        PropertyDispatch.initial(MangrovePropaguleBlock.HANGING, MangrovePropaguleBlock.AGE)
                            .generate(
                                (p_408953_, p_408954_) -> p_408953_
                                    ? plainVariant(ModelLocationUtils.getModelLocation(block, "_hanging_" + p_408954_))
                                    : multivariant
                            )
                    )
            );
    ...
    public void createBarsAndItem(Block block, Block waxedBlock) {
        ...
        ResourceLocation resourcelocation1 = ModelTemplates.BARS_POST.create(block, texturemapping, this.modelOutput);
        ResourceLocation resourcelocation2 = ModelTemplates.BARS_CAP.create(block, texturemapping, this.modelOutput);
        ResourceLocation resourcelocation3 = ModelTemplates.BARS_CAP_ALT.create(block, texturemapping, this.modelOutput);
        ResourceLocation resourcelocation4 = ModelTemplates.BARS_POST_SIDE.create(block, texturemapping, this.modelOutput);
        ResourceLocation resourcelocation5 = ModelTemplates.BARS_POST_SIDE_ALT.create(block, texturemapping, this.modelOutput);
        this.createBars(block, resourcelocation, resourcelocation1, resourcelocation2, resourcelocation3, resourcelocation4, resourcelocation5);
        this.createBars(waxedBlock, resourcelocation, resourcelocation1, resourcelocation2, resourcelocation3, resourcelocation4, resourcelocation5);
        this.registerSimpleFlatItemModel(block);
        this.itemModelOutput.copy(block.asItem(), waxedBlock.asItem());
    }
    ...
    public void createBars(
        Block block,
        ResourceLocation postEnds,
        ResourceLocation post,
        ResourceLocation cap,
        ResourceLocation capAlt,
        ResourceLocation postSide,
        ResourceLocation postSideAlt
    ) {
                ...
                MultiVariantGenerator.dispatch(Blocks.REPEATER)
                    .with(
                        PropertyDispatch.initial(BlockStateProperties.DELAY, BlockStateProperties.LOCKED, BlockStateProperties.POWERED)
                            .generate((p_408959_, p_408960_, p_408961_) -> {
                                StringBuilder stringbuilder = new StringBuilder();
                                stringbuilder.append('_').append(p_408959_).append("tick");
                                if (p_408961_) {
                ...
                MultiVariantGenerator.dispatch(Blocks.SNOW)
                    .with(
                        PropertyDispatch.initial(BlockStateProperties.LAYERS)
                            .generate(
                                p_408987_ -> p_408987_ < 8
                                    ? plainVariant(ModelLocationUtils.getModelLocation(Blocks.SNOW, "_height" + p_408987_ * 2))
                                    : multivariant
                            )
                    )
            );
                ...
                MultiVariantGenerator.dispatch(Blocks.STRUCTURE_BLOCK)
                    .with(
                        PropertyDispatch.initial(BlockStateProperties.STRUCTUREBLOCK_MODE)
                            .generate(
                                p_408958_ -> plainVariant(
                                    this.createSuffixedVariant(
                                        Blocks.STRUCTURE_BLOCK, "_" + p_408958_.getSerializedName(), ModelTemplates.CUBE_ALL, TextureMapping::cube
                                    )
                                )
                            )
                    )
        ...
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.dispatch(Blocks.TEST_BLOCK)
                    .with(PropertyDispatch.initial(BlockStateProperties.TEST_BLOCK_MODE).generate(p_408989_ -> plainVariant(map.get(p_408989_))))
            );
        this.itemModelOutput
            .accept(
                Items.TEST_BLOCK,
            ...
            .accept(
                MultiVariantGenerator.dispatch(Blocks.SWEET_BERRY_BUSH)
                    .with(
                        PropertyDispatch.initial(BlockStateProperties.AGE_3)
                            .generate(
                                p_408965_ -> plainVariant(
                                    this.createSuffixedVariant(Blocks.SWEET_BERRY_BUSH, "_stage" + p_408965_, ModelTemplates.CROSS, TextureMapping::cross)
                                )
                            )
                    )
            );
                ...
                MultiVariantGenerator.dispatch(Blocks.TRIPWIRE_HOOK)
                    .with(
                        PropertyDispatch.initial(BlockStateProperties.ATTACHED, BlockStateProperties.POWERED)
                            .generate(
                                (p_409004_, p_409005_) -> plainVariant(
                                    ModelLocationUtils.getModelLocation(Blocks.TRIPWIRE_HOOK, (p_409004_ ? "_attached" : "") + (p_409005_ ? "_on" : ""))
                                )
                            )
                    )
                    .with(ROTATION_HORIZONTAL_FACING)
    ...
    public void createDriedGhastBlock() {
        ...
        Function<Integer, ResourceLocation> function = p_414884_ -> {
            String s = switch (p_414884_) {
                case 1 -> "_hydration_1";
                case 2 -> "_hydration_2";
                case 3 -> "_hydration_3";
        ...
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.dispatch(Blocks.DRIED_GHAST)
                    .with(PropertyDispatch.initial(DriedGhastBlock.HYDRATION_LEVEL).generate(p_414886_ -> plainVariant(function.apply(p_414886_))))
                    .with(ROTATION_HORIZONTAL_FACING)
            );
    }
    ...
    public void createSnifferEgg() {
        ...
        this.blockStateOutput
            .accept(MultiVariantGenerator.dispatch(Blocks.SNIFFER_EGG).with(PropertyDispatch.initial(SnifferEggBlock.HATCH).generate(p_408983_ -> {
                String s = switch (p_408983_) {
    ...
    public void createMossyCarpet(Block block) {
        ...
        MultiVariant multivariant1 = plainVariant(
            TexturedModel.MOSSY_CARPET_SIDE
                .get(block)
                .updateTextures(p_387855_ -> p_387855_.put(TextureSlot.SIDE, TextureMapping.getBlockTexture(block, "_side_tall")))
                .createWithSuffix(block, "_side_tall", this.modelOutput)
        );
        MultiVariant multivariant2 = plainVariant(
            TexturedModel.MOSSY_CARPET_SIDE
                .get(block)
                .updateTextures(p_386949_ -> p_386949_.put(TextureSlot.SIDE, TextureMapping.getBlockTexture(block, "_side_small")))
    ...
    public void createHangingMoss(Block block) {
        this.registerSimpleFlatItemModel(block);
        this.blockStateOutput.accept(MultiVariantGenerator.dispatch(block).with(PropertyDispatch.initial(HangingMossBlock.TIP).generate(p_408963_ -> {
    ...
    public void addBookSlotModel(
        ...
        MultiVariant multivariant = plainVariant(
            CHISELED_BOOKSHELF_SLOT_MODEL_CACHE.computeIfAbsent(
                ...
                p_387964_ -> template.createWithSuffix(Blocks.CHISELED_BOOKSHELF, s, texturemapping, this.modelOutput)
            )
        );
        generator.with(
    ...
    public void createShulkerBox(Block block, @Nullable DyeColor color) {
        ...
        ItemModel.Unbaked itemmodel$unbaked = color != null
            ? ItemModelUtils.specialModel(resourcelocation, new ShulkerBoxSpecialRenderer.Unbaked(color))
        ...
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.dispatch(Blocks.RESPAWN_ANCHOR)
                    .with(
                        PropertyDispatch.initial(BlockStateProperties.RESPAWN_ANCHOR_CHARGES).generate(p_408991_ -> plainVariant(aresourcelocation[p_408991_]))
                    )
            );
        ...
        this.itemModelOutput
            .accept(
                ...
                ItemModelUtils.selectBlockItemProperty(
                    ...
                    ItemModelUtils.specialModel(resourcelocation, new CopperGolemStatueSpecialRenderer.Unbaked(weatherState, CopperGolemStatueBlock.Pose.STANDING)),
                    Map.of(
                        CopperGolemStatueBlock.Pose.SITTING,
                        ItemModelUtils.specialModel(
                            resourcelocation, new CopperGolemStatueSpecialRenderer.Unbaked(weatherState, CopperGolemStatueBlock.Pose.SITTING)
                        ),
                        CopperGolemStatueBlock.Pose.STAR,
                        ItemModelUtils.specialModel(resourcelocation, new CopperGolemStatueSpecialRenderer.Unbaked(weatherState, CopperGolemStatueBlock.Pose.STAR)),
                        CopperGolemStatueBlock.Pose.RUNNING,
                        ItemModelUtils.specialModel(
                            resourcelocation, new CopperGolemStatueSpecialRenderer.Unbaked(weatherState, CopperGolemStatueBlock.Pose.RUNNING)
                        )
                    )
                )
            );
    ...
    public void createBanner(Block block, Block wallBlock, DyeColor color) {
        ...
        Item item = block.asItem();
        this.itemModelOutput.accept(item, ItemModelUtils.specialModel(resourcelocation, new BannerSpecialRenderer.Unbaked(color)));
    }
    ...
    public void createChest(Block chestBlock, Block particleBlock, ResourceLocation texture, boolean useGiftTexture) {
        ...
        ResourceLocation resourcelocation = ModelTemplates.CHEST_INVENTORY.create(item, TextureMapping.particle(particleBlock), this.modelOutput);
        ItemModel.Unbaked itemmodel$unbaked = ItemModelUtils.specialModel(resourcelocation, new ChestSpecialRenderer.Unbaked(texture));
        if (useGiftTexture) {
    ...
    public void createBed(Block block, Block particleBlock, DyeColor color) {
        ...
        this.itemModelOutput.accept(item, ItemModelUtils.specialModel(resourcelocation, new BedSpecialRenderer.Unbaked(color)));
    }
    ...
    public void generateSimpleSpecialItemModel(Block block, SpecialModelRenderer.Unbaked specialModel) {
        ...
        this.itemModelOutput.accept(item, ItemModelUtils.specialModel(resourcelocation, specialModel));
    }
    ...
    public void createLightBlock() {
        ...
        for (int i = 0; i <= 15; i++) {
            ...
            c1.select(
                i, plainVariant(ModelTemplates.PARTICLE_ONLY.createWithSuffix(Blocks.LIGHT, s, TextureMapping.particle(resourcelocation), this.modelOutput))
            );
    ...
    public void createCopperChainItem(Item item, Item waxedItem) {
        ...
        this.registerSimpleItemModel(item, resourcelocation);
        this.registerSimpleItemModel(waxedItem, resourcelocation);
    }
    ...
    public class BlockFamilyProvider {
        ...
        public BlockModelGenerators.BlockFamilyProvider donateModelTo(Block sourceBlock, Block block) {
            ...
            BlockModelGenerators.this.blockStateOutput
                .accept(BlockModelGenerators.createSimpleBlock(block, BlockModelGenerators.plainVariant(resourcelocation)));
        ...
        public BlockModelGenerators.BlockFamilyProvider button(Block buttonBlock) {
            ...
            ResourceLocation resourcelocation = ModelTemplates.BUTTON_INVENTORY.create(buttonBlock, this.mapping, BlockModelGenerators.this.modelOutput);
            BlockModelGenerators.this.registerSimpleItemModel(buttonBlock, resourcelocation);
            return this;
        }
        ...
        public BlockModelGenerators.BlockFamilyProvider wall(Block wallBlock) {
            ...
            ResourceLocation resourcelocation = ModelTemplates.WALL_INVENTORY.create(wallBlock, this.mapping, BlockModelGenerators.this.modelOutput);
            BlockModelGenerators.this.registerSimpleItemModel(wallBlock, resourcelocation);
            return this;
        }
        ...
        public BlockModelGenerators.BlockFamilyProvider customFence(Block fenceBlock) {
            ...
            ResourceLocation resourcelocation = ModelTemplates.CUSTOM_FENCE_INVENTORY.create(fenceBlock, texturemapping, BlockModelGenerators.this.modelOutput);
            BlockModelGenerators.this.registerSimpleItemModel(fenceBlock, resourcelocation);
            return this;
        }
        ...
        public BlockModelGenerators.BlockFamilyProvider fence(Block fenceBlock) {
            ...
            ResourceLocation resourcelocation = ModelTemplates.FENCE_INVENTORY.create(fenceBlock, this.mapping, BlockModelGenerators.this.modelOutput);
            BlockModelGenerators.this.registerSimpleItemModel(fenceBlock, resourcelocation);
            return this;
        }
                ...
                BlockModelGenerators.this.blockStateOutput
                    .accept(
                        BlockModelGenerators.createSlab(
                            slabBlock, BlockModelGenerators.plainVariant(resourcelocation), multivariant, BlockModelGenerators.variant(this.fullBlock)
                        )
                    );
                BlockModelGenerators.this.registerSimpleItemModel(slabBlock, resourcelocation);
                return this;
            }
        }
        ...
        public BlockModelGenerators.BlockFamilyProvider stairs(Block stairsBlock) {
            ...
            ResourceLocation resourcelocation = this.getOrCreateModel(ModelTemplates.STAIRS_STRAIGHT, stairsBlock);
            ...
            BlockModelGenerators.this.blockStateOutput
                .accept(BlockModelGenerators.createStairs(stairsBlock, multivariant, BlockModelGenerators.plainVariant(resourcelocation), multivariant1));
            BlockModelGenerators.this.registerSimpleItemModel(stairsBlock, resourcelocation);
            return this;
        }
        ...
        public ResourceLocation getOrCreateModel(ModelTemplate modelTemplate, Block block) {
            return this.models.computeIfAbsent(modelTemplate, p_387666_ -> p_387666_.create(block, this.mapping, BlockModelGenerators.this.modelOutput));
        }
    ...
    public interface BlockStateGeneratorSupplier {
        BlockModelDefinitionGenerator create(
            Block block, Variant variant, TextureMapping textureMapping, BiConsumer<ResourceLocation, ModelInstance> output
        );
    }
    ...
    public class WoodProvider {
        ...
        public BlockModelGenerators.WoodProvider wood(Block woodBlock) {
            ...
            BlockModelGenerators.this.blockStateOutput
                .accept(BlockModelGenerators.createAxisAlignedPillarBlock(woodBlock, BlockModelGenerators.plainVariant(resourcelocation)));
            BlockModelGenerators.this.registerSimpleItemModel(woodBlock, resourcelocation);
            return this;
        }
        ...
        public BlockModelGenerators.WoodProvider log(Block logBlock) {
            ...
            BlockModelGenerators.this.blockStateOutput
                .accept(BlockModelGenerators.createAxisAlignedPillarBlock(logBlock, BlockModelGenerators.plainVariant(resourcelocation)));
            BlockModelGenerators.this.registerSimpleItemModel(logBlock, resourcelocation);
            return this;
        }
        ...
        public BlockModelGenerators.WoodProvider logWithHorizontal(Block logBlock) {
            ...
            BlockModelGenerators.this.blockStateOutput
                .accept(
                    BlockModelGenerators.createRotatedPillarWithHorizontalVariant(logBlock, BlockModelGenerators.plainVariant(resourcelocation), multivariant)
                );
            BlockModelGenerators.this.registerSimpleItemModel(logBlock, resourcelocation);
            return this;
        }
