...
public class ItemModelGenerators {
    ...
    public static ResourceLocation prefixForSlotTrim(String name) {
        return ResourceLocation.withDefaultNamespace("trims/items/" + name + "_trim");
    }
    ...
    public ResourceLocation createFlatItemModel(Item item, String suffix, ModelTemplate modelTemplate) {
    ...
    public void generateItemWithTintedOverlay(Item item, String suffix, ItemTintSource tintSource) {
        ...
        this.itemModelOutput.accept(item, ItemModelUtils.tintedModel(resourcelocation, BLANK_LAYER, tintSource));
    }
    ...
    public void generateTrimmableItem(Item item, ResourceKey<EquipmentAsset> equipmentAsset, ResourceLocation modelId, boolean usesSecondLayer) {
        ...
        for (ItemModelGenerators.TrimMaterialData itemmodelgenerators$trimmaterialdata : TRIM_MATERIAL_MODELS) {
            ...
            ResourceLocation resourcelocation4 = modelId.withSuffix("_" + itemmodelgenerators$trimmaterialdata.assets().assetId(equipmentAsset).suffix());
    ...
    public void generateBundleModels(Item bundleItem) {
        ...
        ResourceLocation resourcelocation = this.generateBundleCoverModel(bundleItem, ModelTemplates.BUNDLE_OPEN_BACK_INVENTORY, "_open_back");
        ResourceLocation resourcelocation1 = this.generateBundleCoverModel(bundleItem, ModelTemplates.BUNDLE_OPEN_FRONT_INVENTORY, "_open_front");
    ...
    public ResourceLocation generateBundleCoverModel(Item bundleItem, ModelTemplate modelTemplate, String suffix) {
        ResourceLocation resourcelocation = TextureMapping.getItemTexture(bundleItem, suffix);
        return modelTemplate.create(bundleItem, TextureMapping.layer0(resourcelocation), this.modelOutput);
    }
    ...
    public void addPotionTint(Item potionItem, ResourceLocation model) {
    ...
    public void generateDyedItem(Item item, int color) {
        ...
        this.itemModelOutput.accept(item, ItemModelUtils.tintedModel(resourcelocation, new Dye(color)));
    }

    public void generateTwoLayerDyedItem(Item item) {
        ResourceLocation resourcelocation = TextureMapping.getItemTexture(item);
        ResourceLocation resourcelocation1 = TextureMapping.getItemTexture(item, "_overlay");
        ResourceLocation resourcelocation2 = ModelTemplates.FLAT_ITEM.create(item, TextureMapping.layer0(resourcelocation), this.modelOutput);
        ResourceLocation resourcelocation3 = ModelLocationUtils.getModelLocation(item, "_dyed");
