...
public class Material {
    ...
    public VertexConsumer buffer(MaterialSet materials, MultiBufferSource bufferSource, Function<ResourceLocation, RenderType> renderTypeGetter) {
        return materials.get(this).wrap(bufferSource.getBuffer(this.renderType(renderTypeGetter)));
    }

    public VertexConsumer buffer(
        MaterialSet materials, MultiBufferSource bufferSource, Function<ResourceLocation, RenderType> renderTypeGetter, boolean isItem, boolean glint
    ) {
