...
public class BiomeAmbientSoundsHandler implements AmbientSoundHandler {
    ...
    public void tick() {
        ...
        if (biome != this.previousBiome) {
            ...
            biome.getAmbientLoop().ifPresent(p_263342_ -> this.loopSounds.compute(biome, (p_426940_, p_426941_) -> {
                if (p_426941_ == null) {
                    p_426941_ = new BiomeAmbientSoundsHandler.LoopSoundInstance((SoundEvent)p_263342_.value());
        ...
        this.additionsSettings.ifPresent(p_426938_ -> {
            if (this.random.nextDouble() < p_426938_.getTickChance()) {
                this.soundManager.play(SimpleSoundInstance.forAmbientAddition(p_426938_.getSoundEvent().value()));
            }
        });
        this.moodSettings
            .ifPresent(
