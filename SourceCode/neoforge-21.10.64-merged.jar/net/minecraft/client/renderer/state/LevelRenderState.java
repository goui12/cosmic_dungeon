...
public class LevelRenderState extends net.neoforged.neoforge.client.renderstate.BaseRenderState {
    ...
    public net.minecraft.client.renderer.DimensionSpecialEffects dimensionSpecialEffects = net.neoforged.neoforge.client.DimensionSpecialEffectsManager.getDefaultEffects();
    ...
    public void reset() {
        ...
        this.dimensionSpecialEffects = net.neoforged.neoforge.client.DimensionSpecialEffectsManager.getDefaultEffects();
