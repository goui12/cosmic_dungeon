...
public class LightSectionDebugRenderer implements DebugRenderer.SimpleDebugRenderer {
    ...
    private static void renderFace(
        ...
        float f1 = (float)(SectionPos.sectionToBlockCoord(blockY) - camY);
        float f2 = (float)(SectionPos.sectionToBlockCoord(blockZ) - camZ);
    ...
    private static void renderEdge(
        ...
        float f1 = (float)(SectionPos.sectionToBlockCoord(y1) - camY);
        float f2 = (float)(SectionPos.sectionToBlockCoord(z1) - camZ);
        float f3 = (float)(SectionPos.sectionToBlockCoord(x2) - camX);
        float f4 = (float)(SectionPos.sectionToBlockCoord(y2) - camY);
        float f5 = (float)(SectionPos.sectionToBlockCoord(z2) - camZ);
