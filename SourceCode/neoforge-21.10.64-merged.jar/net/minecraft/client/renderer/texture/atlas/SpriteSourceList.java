...
public class SpriteSourceList {
    ...
    public List<Function<SpriteResourceLoader, SpriteContents>> list(ResourceManager resourceManager, java.util.Set<net.minecraft.server.packs.metadata.MetadataSectionType<?>> additionalMetadata) {
