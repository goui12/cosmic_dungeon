...
public class BiomeColors {
    ...
    public static int getAverageDryFoliageColor(BlockAndTintGetter level, BlockPos blockPos) {
        return getAverageColor(level, blockPos, DRY_FOLIAGE_COLOR_RESOLVER);
    }
