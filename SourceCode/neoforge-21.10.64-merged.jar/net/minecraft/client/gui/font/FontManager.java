...
public class FontManager implements PreparableReloadListener, AutoCloseable {
    ...
    private FontSet createFontSet(ResourceLocation name, List<GlyphProvider.Conditional> allProviders, Set<FontOption> options) {
    ...
    public CompletableFuture<Void> reload(
        ...
        return this.prepare(sharedState.resourceManager(), exectutor)
            .thenCompose(barrier::wait)
            .thenAcceptAsync(p_372503_ -> this.apply(p_372503_, Profiler.get()), applyExectutor);
    }
    ...
    private void apply(FontManager.Preparation preparation, ProfilerFiller profiler) {
        ...
        preparation.fontSets()
            .forEach(
                (p_432219_, p_432220_) -> this.fontSets
                    .put(p_432219_, this.createFontSet(p_432219_, Lists.reverse((List<GlyphProvider.Conditional>)p_432220_), set))
            );
        ...
        if (!this.fontSets.containsKey(Minecraft.DEFAULT_FONT)) {
            ...
            this.atlasManager.forEach((p_436485_, p_436486_) -> this.atlasProviders.put(p_436485_, new AtlasGlyphProvider(p_436486_)));
        }
    }
    ...
    FontSet getFontSetRaw(ResourceLocation fontSet) {
    ...
    class CachedFontProvider implements Font.Provider, AutoCloseable {
        ...
        public GlyphSource glyphs(FontDescription fontDescription) {
            ...
            if (fontmanager$cachedfontprovider$cachedentry != null && fontDescription.equals(fontmanager$cachedfontprovider$cachedentry.description)) {
