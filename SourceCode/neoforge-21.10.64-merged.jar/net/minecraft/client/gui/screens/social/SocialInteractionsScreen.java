...
public class SocialInteractionsScreen extends Screen {
    ...
    public void renderBackground(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        guiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, BACKGROUND_SPRITE, i, 64, 236, this.windowHeight() + 16);
        guiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, SEARCH_SPRITE, i + 10, 76, 12, 12);
    }
