...
public class PackSelectionModel {
    ...
    public PackSelectionModel(
        Consumer<PackSelectionModel.EntryBase> onListChanged, Function<Pack, ResourceLocation> iconGetter, PackRepository repository, Consumer<PackRepository> output
    ) {
