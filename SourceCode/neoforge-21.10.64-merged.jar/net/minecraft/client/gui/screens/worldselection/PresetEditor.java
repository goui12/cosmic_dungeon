...
public interface PresetEditor {
    ...
    static WorldCreationContext.DimensionsUpdater flatWorldConfigurator(FlatLevelGeneratorSettings settings) {
    ...
    private static WorldCreationContext.DimensionsUpdater fixedBiomeConfigurator(Holder<Biome> biome) {
        return (p_396284_, p_396285_) -> {
            Registry<NoiseGeneratorSettings> registry = p_396284_.lookupOrThrow(Registries.NOISE_SETTINGS);
            ...
            return p_396285_.replaceOverworldGenerator(p_396284_, chunkgenerator);
        };
    }
}
