...
public class IntegratedServer extends MinecraftServer {
    ...
    public boolean isSingleplayerOwner(NameAndId player) {
        return this.getSingleplayerProfile() != null && player.name().equalsIgnoreCase(this.getSingleplayerProfile().name());
    }
    ...
    public boolean saveEverything(boolean suppressLogs, boolean flush, boolean force) {
        boolean flag = super.saveEverything(suppressLogs, flush, force);
