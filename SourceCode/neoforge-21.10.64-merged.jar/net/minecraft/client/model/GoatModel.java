...
public class GoatModel extends QuadrupedModel<GoatRenderState> {
    ...
    public void setupAnim(GoatRenderState renderState) {
        super.setupAnim(renderState);
        this.head.getChild("left_horn").visible = renderState.hasLeftHorn;
        this.head.getChild("right_horn").visible = renderState.hasRightHorn;
        if (renderState.rammingXHeadRot != 0.0F) {
            this.head.xRot = renderState.rammingXHeadRot;
        }
    }
}
