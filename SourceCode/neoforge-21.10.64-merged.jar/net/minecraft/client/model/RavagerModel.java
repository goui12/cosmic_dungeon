...
public class RavagerModel extends EntityModel<RavagerRenderState> {
    ...
    public void setupAnim(RavagerRenderState renderState) {
        super.setupAnim(renderState);
        float f = renderState.stunnedTicksRemaining;
        float f1 = renderState.attackTicksRemaining;
        int i = 10;
        if (f1 > 0.0F) {
            ...
            } else if (renderState.roarAnimation > 0.0) {
                float f10 = Mth.sin(renderState.roarAnimation * (float) Math.PI * 0.25F);
        ...
        float f7 = renderState.walkAnimationPos;
        float f9 = 0.4F * renderState.walkAnimationSpeed;
