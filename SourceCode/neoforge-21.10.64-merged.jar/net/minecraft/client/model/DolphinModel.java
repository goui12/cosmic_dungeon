...
public class DolphinModel extends EntityModel<DolphinRenderState> {
    ...
    public void setupAnim(DolphinRenderState renderState) {
        ...
        if (renderState.isMoving) {
            this.body.xRot = this.body.xRot + (-0.05F - 0.05F * Mth.cos(renderState.ageInTicks * 0.3F));
            this.tail.xRot = -0.1F * Mth.cos(renderState.ageInTicks * 0.3F);
            this.tailFin.xRot = -0.2F * Mth.cos(renderState.ageInTicks * 0.3F);
        }
    }
}
