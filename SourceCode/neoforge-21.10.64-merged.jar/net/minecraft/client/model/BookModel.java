...
public class BookModel extends Model<BookModel.State> {
    ...
    public void setupAnim(BookModel.State renderState) {
        super.setupAnim(renderState);
        float f = (Mth.sin(renderState.animationPos * 0.02F) * 0.1F + 1.25F) * renderState.open;
        this.leftLid.yRot = (float) Math.PI + f;
        this.rightLid.yRot = -f;
        this.leftPages.yRot = f;
        this.rightPages.yRot = -f;
        this.flipPage1.yRot = f - f * 2.0F * renderState.pageFlip1;
        this.flipPage2.yRot = f - f * 2.0F * renderState.pageFlip2;
