...
public class FelineModel<T extends FelineRenderState> extends EntityModel<T> {
    ...
    public void setupAnim(T renderState) {
        ...
        if (renderState.lieDownAmount > 0.0F) {
            this.head.zRot = Mth.rotLerp(renderState.lieDownAmount, this.head.zRot, -1.2707963F);
            this.head.yRot = Mth.rotLerp(renderState.lieDownAmount, this.head.yRot, 1.2707963F);
            ...
            this.tail1.xRot = Mth.rotLerp(renderState.lieDownAmountTail, this.tail1.xRot, 0.8F);
            this.tail2.xRot = Mth.rotLerp(renderState.lieDownAmountTail, this.tail2.xRot, -0.4F);
        }

        if (renderState.relaxStateOneAmount > 0.0F) {
