...
public class WitherBossModel extends EntityModel<WitherRenderState> {
    ...
    public void setupAnim(WitherRenderState renderState) {
        super.setupAnim(renderState);
        setupHeadRotation(renderState, this.rightHead, 0);
        setupHeadRotation(renderState, this.leftHead, 1);
        float f = Mth.cos(renderState.ageInTicks * 0.1F);
        ...
        this.centerHead.yRot = renderState.yRot * (float) (Math.PI / 180.0);
        this.centerHead.xRot = renderState.xRot * (float) (Math.PI / 180.0);
    }
