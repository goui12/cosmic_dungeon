...
public class AbstractPiglinModel<S extends HumanoidRenderState> extends HumanoidModel<S> {
    ...
    public static ArmorModelSet<MeshDefinition> createArmorMeshSet(CubeDeformation innerArmorCubeDeformation, CubeDeformation outerArmorCubeDeformation) {
        return PlayerModel.createArmorMeshSet(innerArmorCubeDeformation, outerArmorCubeDeformation).map(p_436064_ -> {
            PartDefinition partdefinition = p_436064_.getRoot();
            ...
            return (MeshDefinition)p_436064_;
        });
    }
    ...
    public void setupAnim(S renderState) {
        ...
        float f3 = renderState.ageInTicks * 0.1F + f * 0.5F;
