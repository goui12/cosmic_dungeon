...
public class StriderModel extends EntityModel<StriderRenderState> {
    ...
    public void setupAnim(StriderRenderState renderState) {
        super.setupAnim(renderState);
        float f = renderState.walkAnimationPos;
        float f1 = Math.min(renderState.walkAnimationSpeed, 0.25F);
        if (!renderState.isRidden) {
            this.body.xRot = renderState.xRot * (float) (Math.PI / 180.0);
            this.body.yRot = renderState.yRot * (float) (Math.PI / 180.0);
        } else {
            this.body.xRot = 0.0F;
            this.body.yRot = 0.0F;
        }
        ...
        float f4 = 1.0F;
        float f5 = 1.0F;
        this.rightBottomBristle.zRot = this.rightBottomBristle.zRot + 0.05F * Mth.sin(renderState.ageInTicks * 1.0F * -0.4F);
        this.rightMiddleBristle.zRot = this.rightMiddleBristle.zRot + 0.1F * Mth.sin(renderState.ageInTicks * 1.0F * 0.2F);
        this.rightTopBristle.zRot = this.rightTopBristle.zRot + 0.1F * Mth.sin(renderState.ageInTicks * 1.0F * 0.4F);
        this.leftTopBristle.zRot = this.leftTopBristle.zRot + 0.1F * Mth.sin(renderState.ageInTicks * 1.0F * 0.4F);
        this.leftMiddleBristle.zRot = this.leftMiddleBristle.zRot + 0.1F * Mth.sin(renderState.ageInTicks * 1.0F * 0.2F);
        this.leftBottomBristle.zRot = this.leftBottomBristle.zRot + 0.05F * Mth.sin(renderState.ageInTicks * 1.0F * -0.4F);
    }
}
