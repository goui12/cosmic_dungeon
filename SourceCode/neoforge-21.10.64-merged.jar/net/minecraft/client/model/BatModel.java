...
public class BatModel extends EntityModel<BatRenderState> {
    ...
    public void setupAnim(BatRenderState renderState) {
        super.setupAnim(renderState);
        if (renderState.isResting) {
            this.applyHeadRotation(renderState.yRot);
        }

        this.flyingAnimation.apply(renderState.flyAnimationState, renderState.ageInTicks);
        this.restingAnimation.apply(renderState.restAnimationState, renderState.ageInTicks);
    }
