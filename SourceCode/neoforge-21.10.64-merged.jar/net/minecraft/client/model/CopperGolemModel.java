...
public class CopperGolemModel extends EntityModel<CopperGolemRenderState> implements ArmedModel<CopperGolemRenderState>, HeadedModel {
    ...
    public static LayerDefinition createBodyLayer() {
        MeshDefinition meshdefinition = new MeshDefinition().transformed(p_435139_ -> p_435139_.translated(0.0F, 24.0F, 0.0F));
    ...
    public static LayerDefinition createRunningPoseBodyLayer() {
        MeshDefinition meshdefinition = new MeshDefinition().transformed(p_434754_ -> p_434754_.translated(0.0F, 0.0F, 0.0F));
        PartDefinition partdefinition = meshdefinition.getRoot();
    ...
    public static LayerDefinition createSittingPoseBodyLayer() {
        MeshDefinition meshdefinition = new MeshDefinition().transformed(p_432950_ -> p_432950_.translated(0.0F, 0.0F, 0.0F));
        PartDefinition partdefinition = meshdefinition.getRoot();
        PartDefinition partdefinition1 = partdefinition.addOrReplaceChild(
            "body",
            CubeListBuilder.create()
    ...
    public static LayerDefinition createStarPoseBodyLayer() {
        MeshDefinition meshdefinition = new MeshDefinition().transformed(p_433163_ -> p_433163_.translated(0.0F, 0.0F, 0.0F));
        PartDefinition partdefinition = meshdefinition.getRoot();
        PartDefinition partdefinition1 = partdefinition.addOrReplaceChild(
            "body",
    ...
    public static LayerDefinition createEyesLayer() {
        return createBodyLayer().apply(p_433933_ -> {
            p_433933_.getRoot().retainPartsAndChildren(Set.of("eyes"));
            return p_433933_;
        });
    }
    ...
    public void setupAnim(CopperGolemRenderState renderState) {
        ...
        if (renderState.rightHandItem.isEmpty() && renderState.leftHandItem.isEmpty()) {
            this.walkAnimation.applyWalk(renderState.walkAnimationPos, renderState.walkAnimationSpeed, 2.0F, 2.5F);
        } else {
            this.walkWithItemAnimation.applyWalk(renderState.walkAnimationPos, renderState.walkAnimationSpeed, 2.0F, 2.5F);
            this.poseHeldItemArmsIfStill();
        }

        this.idleAnimation.apply(renderState.idleAnimationState, renderState.ageInTicks);
        this.interactionGetItem.apply(renderState.interactionGetItem, renderState.ageInTicks);
        this.interactionGetNoItem.apply(renderState.interactionGetNoItem, renderState.ageInTicks);
        this.interactionDropItem.apply(renderState.interactionDropItem, renderState.ageInTicks);
        this.interactionDropNoItem.apply(renderState.interactionDropNoItem, renderState.ageInTicks);
    }

    public void translateToHand(CopperGolemRenderState renderState, HumanoidArm arm, PoseStack poseStack) {
        this.root.translateAndRotate(poseStack);
        this.body.translateAndRotate(poseStack);
        ModelPart modelpart = arm == HumanoidArm.RIGHT ? this.rightArm : this.leftArm;
        modelpart.translateAndRotate(poseStack);
        if (renderState.copperGolemState.equals(CopperGolemState.IDLE)) {
