...
public class TurtleModel extends QuadrupedModel<TurtleRenderState> {
    ...
    public void setupAnim(TurtleRenderState renderState) {
        super.setupAnim(renderState);
        float f = renderState.walkAnimationPos;
        float f1 = renderState.walkAnimationSpeed;
        if (renderState.isOnLand) {
            float f2 = renderState.isLayingEgg ? 4.0F : 1.0F;
            float f3 = renderState.isLayingEgg ? 2.0F : 1.0F;
            float f4 = f * 5.0F;
        ...
        this.eggBelly.visible = renderState.hasEgg;
