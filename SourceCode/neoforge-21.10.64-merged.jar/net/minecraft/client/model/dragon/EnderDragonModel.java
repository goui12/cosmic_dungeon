...
public class EnderDragonModel extends EntityModel<EnderDragonRenderState> {
    ...
    public void setupAnim(EnderDragonRenderState renderState) {
        super.setupAnim(renderState);
        float f = renderState.flapTime * (float) (Math.PI * 2);
        ...
        float f5 = 1.5F;
        DragonFlightHistory.Sample dragonflighthistory$sample = renderState.getHistoricalPos(6);
        float f6 = Mth.wrapDegrees(renderState.getHistoricalPos(5).yRot() - renderState.getHistoricalPos(10).yRot());
        float f7 = Mth.wrapDegrees(renderState.getHistoricalPos(5).yRot() + f6 / 2.0F);

        for (int i = 0; i < 5; i++) {
            ModelPart modelpart = this.neckParts[i];
            DragonFlightHistory.Sample dragonflighthistory$sample1 = renderState.getHistoricalPos(5 - i);
            ...
            modelpart.xRot = f8
                + renderState.getHeadPartYOffset(i, dragonflighthistory$sample, dragonflighthistory$sample1) * (float) (Math.PI / 180.0) * 1.5F * 5.0F;
        ...
        this.head.z = f4;
        this.head.x = f2;
        DragonFlightHistory.Sample dragonflighthistory$sample2 = renderState.getHistoricalPos(0);
        this.head.yRot = Mth.wrapDegrees(dragonflighthistory$sample2.yRot() - dragonflighthistory$sample.yRot()) * (float) (Math.PI / 180.0);
        this.head.xRot = Mth.wrapDegrees(renderState.getHeadPartYOffset(6, dragonflighthistory$sample, dragonflighthistory$sample2))
            * (float) (Math.PI / 180.0)
            * 1.5F
            * 5.0F;
        ...
        dragonflighthistory$sample = renderState.getHistoricalPos(11);

        for (int j = 0; j < 12; j++) {
            DragonFlightHistory.Sample dragonflighthistory$sample3 = renderState.getHistoricalPos(12 + j);
