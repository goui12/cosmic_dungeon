...
public class ArmorStandModel extends ArmorStandArmorModel {
    ...
    public void setupAnim(ArmorStandRenderState p_360688_) {
        ...
        this.rightBodyStick.xRot = (float) (Math.PI / 180.0) * p_360688_.bodyPose.x();
        this.rightBodyStick.yRot = (float) (Math.PI / 180.0) * p_360688_.bodyPose.y();
        this.rightBodyStick.zRot = (float) (Math.PI / 180.0) * p_360688_.bodyPose.z();
        this.leftBodyStick.xRot = (float) (Math.PI / 180.0) * p_360688_.bodyPose.x();
        this.leftBodyStick.yRot = (float) (Math.PI / 180.0) * p_360688_.bodyPose.y();
        this.leftBodyStick.zRot = (float) (Math.PI / 180.0) * p_360688_.bodyPose.z();
        this.shoulderStick.xRot = (float) (Math.PI / 180.0) * p_360688_.bodyPose.x();
        this.shoulderStick.yRot = (float) (Math.PI / 180.0) * p_360688_.bodyPose.y();
        this.shoulderStick.zRot = (float) (Math.PI / 180.0) * p_360688_.bodyPose.z();
    }

    public void translateToHand(ArmorStandRenderState p_436048_, HumanoidArm p_102157_, PoseStack p_102158_) {
        ModelPart modelpart = this.getArm(p_102157_);
        boolean flag = modelpart.visible;
        modelpart.visible = true;
        super.translateToHand(p_436048_, p_102157_, p_102158_);
