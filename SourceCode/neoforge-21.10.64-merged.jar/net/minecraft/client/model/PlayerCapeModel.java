...
public class PlayerCapeModel extends PlayerModel {
    ...
    @Override
    public void setupAnim(AvatarRenderState p_446475_) {
        super.setupAnim(p_446475_);
        this.cape
            .rotateBy(
                new Quaternionf()
                    .rotateY((float) -Math.PI)
                    .rotateX((6.0F + p_446475_.capeLean / 2.0F + p_446475_.capeFlap) * (float) (Math.PI / 180.0))
                    .rotateZ(p_446475_.capeLean2 / 2.0F * (float) (Math.PI / 180.0))
                    .rotateY((180.0F - p_446475_.capeLean2 / 2.0F) * (float) (Math.PI / 180.0))
            );
    }
}
