...
public class CamelSaddleModel extends CamelModel {
    ...
    public CamelSaddleModel(ModelPart p_397097_) {
        super(p_397097_);
    }
    ...
    @Override
    public void setupAnim(CamelRenderState p_397465_) {
        super.setupAnim(p_397465_);
        this.reins.visible = p_397465_.isRidden;
    }
}
