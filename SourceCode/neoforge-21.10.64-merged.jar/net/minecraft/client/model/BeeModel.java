...
public class BeeModel extends EntityModel<BeeRenderState> {
    ...
    public void setupAnim(BeeRenderState renderState) {
        ...
        if (!renderState.isAngry && !renderState.isOnGround) {
            float f1 = Mth.cos(renderState.ageInTicks * 0.18F);
            ...
            this.bone.y = this.bone.y - Mth.cos(renderState.ageInTicks * 0.18F) * 0.9F;
        }
