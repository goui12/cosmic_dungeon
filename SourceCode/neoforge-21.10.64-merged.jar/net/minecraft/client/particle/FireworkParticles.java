...
public class FireworkParticles {
    ...
    public static class FlashProvider implements ParticleProvider<ColorParticleOption> {
        ...
        public Particle createParticle(
            ...
            fireworkparticles$overlayparticle.setColor(particleType.getRed(), particleType.getGreen(), particleType.getBlue());
            fireworkparticles$overlayparticle.setAlpha(particleType.getAlpha());
