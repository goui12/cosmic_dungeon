                                            ...
                                            Commands.argument("respectTeams", BoolArgumentType.bool())
                                                .then(
                                                    Commands.argument("targets", EntityArgument.entities())
                                                        .executes(
                                                            p_451724_ -> spreadPlayers(
                                                                p_451724_.getSource(),
                                                                Vec2Argument.getVec2(p_451724_, "center"),
                                                                FloatArgumentType.getFloat(p_451724_, "spreadDistance"),
                                                                FloatArgumentType.getFloat(p_451724_, "maxRange"),
                                                                p_451724_.getSource().getLevel().getMaxY() + 1,
                                                                BoolArgumentType.getBool(p_451724_, "respectTeams"),
                                                                EntityArgument.getEntities(p_451724_, "targets")
                                                            )
                                                        )
                                                )
                                        )
