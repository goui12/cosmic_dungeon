                                ...
                                .then(
                                    Commands.argument("time", IntegerArgumentType.integer(0))
                                        .executes(
                                            p_445295_ -> setSize(
                                                p_445295_.getSource(),
                                                p_445295_.getSource().getLevel().getWorldBorder().getSize()
                                                    + DoubleArgumentType.getDouble(p_445295_, "distance"),
                                                p_445295_.getSource().getLevel().getWorldBorder().getLerpTime()
                                                    + IntegerArgumentType.getInteger(p_445295_, "time") * 1000L
                                            )
                                        )
                                )
                        )
