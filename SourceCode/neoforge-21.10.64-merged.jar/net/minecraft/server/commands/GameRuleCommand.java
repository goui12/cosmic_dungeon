...
public class GameRuleCommand {
                ...
                new GameRules.GameRuleTypeVisitor() {
                    ...
                    public <T extends GameRules.Value<T>> void visit(GameRules.Key<T> key, GameRules.Type<T> type) {
                        ...
                        literalargumentbuilder.then(
                            literalargumentbuilder1.executes(p_137771_ -> GameRuleCommand.queryRule(p_137771_.getSource(), key))
    ...
    static <T extends GameRules.Value<T>> int setRule(CommandContext<CommandSourceStack> source, GameRules.Key<T> gameRule) {
        ...
        commandsourcestack.getServer().onGameRuleChanged(gameRule.getId(), t);
