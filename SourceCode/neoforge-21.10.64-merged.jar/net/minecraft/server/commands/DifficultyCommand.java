...
public class DifficultyCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        ...
        dispatcher.register(literalargumentbuilder.requires(Commands.hasPermission(2)).executes(p_451719_ -> {
            Difficulty difficulty1 = p_451719_.getSource().getLevel().getDifficulty();
            p_451719_.getSource().sendSuccess(() -> Component.translatable("commands.difficulty.query", difficulty1.getDisplayName()), false);
