                    ...
                    Commands.literal("query")
                        ...
                        .then(
                            Commands.literal("gametime")
                                .executes(p_428128_ -> queryTime(p_428128_.getSource(), (int)(p_428128_.getSource().getLevel().getGameTime() % 2147483647L)))
                        )
                        .then(
                            Commands.literal("day")
                                .executes(
                                    p_428129_ -> queryTime(p_428129_.getSource(), (int)(p_428129_.getSource().getLevel().getDayTime() / 24000L % 2147483647L))
                                )
                        )
                )
        );
