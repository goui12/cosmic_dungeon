...
public class SuppressedExceptionCollector {
    ...
    public synchronized void addEntry(String id, Throwable throwable) {
        ...
        this.latestEntries.add(new SuppressedExceptionCollector.LongEntry(i, id, (Class<? extends Throwable>)throwable.getClass(), s));
        ...
        SuppressedExceptionCollector.ShortEntry suppressedexceptioncollector$shortentry = new SuppressedExceptionCollector.ShortEntry(
            id, (Class<? extends Throwable>)throwable.getClass()
        );
