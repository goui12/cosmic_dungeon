...
public enum DebugEntityBlockIntersection {
    ...
    private static final IntFunction<DebugEntityBlockIntersection> BY_ID = ByIdMap.continuous(
        p_449465_ -> p_449465_.id, values(), ByIdMap.OutOfBoundsStrategy.ZERO
    );
    public static final StreamCodec<ByteBuf, DebugEntityBlockIntersection> STREAM_CODEC = ByteBufCodecs.idMapper(BY_ID, p_449057_ -> p_449057_.id);
