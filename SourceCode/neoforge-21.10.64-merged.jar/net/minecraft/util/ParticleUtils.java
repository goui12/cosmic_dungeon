...
public class ParticleUtils {
    ...
    public static void spawnParticleOnFace(
        ...
        double d0 = vec3.x + (i == 0 ? Mth.nextDouble(level.random, -0.5, 0.5) : i * spread);
        double d1 = vec3.y + (j == 0 ? Mth.nextDouble(level.random, -0.5, 0.5) : j * spread);
        double d2 = vec3.z + (k == 0 ? Mth.nextDouble(level.random, -0.5, 0.5) : k * spread);
    ...
    public static void spawnParticles(
        ...
        for (int i = 0; i < count; i++) {
            ...
            double d4 = pos.getX() + d3 + randomsource.nextDouble() * xzSpread * 2.0;
            double d5 = pos.getY() + randomsource.nextDouble() * ySpread;
            double d6 = pos.getZ() + d3 + randomsource.nextDouble() * xzSpread * 2.0;
