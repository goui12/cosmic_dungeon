...
public class ExtraCodecs {
    ...
    public static final Codec<Vector2f> VECTOR2F = Codec.FLOAT
        .listOf()
        .comapFlatMap(
            p_417757_ -> Util.fixedSize((List<Float>)p_417757_, 2).map(p_417754_ -> new Vector2f(p_417754_.get(0), p_417754_.get(1))),
            p_417755_ -> List.of(p_417755_.x(), p_417755_.y())
        );
    ...
    public static final Codec<Vector3i> VECTOR3I = Codec.INT
        .listOf()
        .comapFlatMap(
            p_417758_ -> Util.fixedSize((List<Integer>)p_417758_, 3).map(p_417756_ -> new Vector3i(p_417756_.get(0), p_417756_.get(1), p_417756_.get(2))),
            p_417753_ -> List.of(p_417753_.x(), p_417753_.y(), p_417753_.z())
        );
    ...
    public static final Codec<Matrix4fc> MATRIX4F = Codec.FLOAT
        .listOf()
        .comapFlatMap(p_337582_ -> Util.fixedSize((List<Float>)p_337582_, 16).map(p_269777_ -> {
    ...
    public static final Codec<Integer> RGB_COLOR_CODEC = Codec.withAlternative(
        Codec.INT, VECTOR3F, p_370488_ -> ARGB.colorFromFloat(1.0F, p_370488_.x(), p_370488_.y(), p_370488_.z())
    );
    public static final Codec<Integer> ARGB_COLOR_CODEC = Codec.withAlternative(
        Codec.INT, VECTOR4F, p_359661_ -> ARGB.colorFromFloat(p_359661_.w(), p_359661_.x(), p_359661_.y(), p_359661_.z())
    );
    ...
    public static final Codec<Integer> POSITIVE_INT = intRangeWithMessage(1, Integer.MAX_VALUE, p_405214_ -> "Value must be positive: " + p_405214_);
    public static final Codec<Float> NON_NEGATIVE_FLOAT = floatRangeMinInclusiveWithMessage(
        0.0F, Float.MAX_VALUE, p_440560_ -> "Value must be non-negative: " + p_440560_
    );
    public static final Codec<Float> POSITIVE_FLOAT = floatRangeMinExclusiveWithMessage(
        0.0F, Float.MAX_VALUE, p_404968_ -> "Value must be positive: " + p_404968_
    );
    ...
    public static final Codec<URI> UNTRUSTED_URI = Codec.STRING.comapFlatMap(p_392801_ -> {
        try {
            return DataResult.success(Util.parseAndValidateUntrustedUri(p_392801_));
