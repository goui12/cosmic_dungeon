...
public class DataFixers {
    ...
    private static void addFixers(DataFixerBuilder builder) {
        ...
        builder.addFixer(
            BlockRenameFix.create(schema129, "Renamed grass path block to dirt path", createRenamer("minecraft:grass_path", "minecraft:dirt_path"))
        );
        ...
        ImmutableMap<String, String> immutablemap1 = ImmutableMap.<String, String>builder()
            ...
            .build();
        builder.addFixer(ItemRenameFix.create(schema134, "Rename copper item suffixes", createRenamer(immutablemap1)));
        builder.addFixer(BlockRenameFix.create(schema134, "Rename copper blocks suffixes", createRenamer(immutablemap1)));
        ...
        ImmutableMap<String, String> immutablemap2 = ImmutableMap.<String, String>builder()
            ...
            .build();
        builder.addFixer(ItemRenameFix.create(schema136, "Renamed grimstone block items to deepslate", createRenamer(immutablemap2)));
        builder.addFixer(BlockRenameFix.create(schema136, "Renamed grimstone blocks to deepslate", createRenamer(immutablemap2)));
        ...
        builder.addFixer(
            new NamespacedTypeRenameFix(
                schema151, "Remove Deep Warm Ocean", References.BIOME, createRenamer("minecraft:deep_warm_ocean", "minecraft:warm_ocean")
            )
        );
        ...
        Schema schema156 = builder.addSchema(3076, V3076::new);
        builder.addFixer(new AddNewChoices(schema156, "Added Sculk Catalyst", References.BLOCK_ENTITY));
        Schema schema157 = builder.addSchema(3077, SAME_NAMESPACED);
        builder.addFixer(new ChunkDeleteIgnoredLightDataFix(schema157));
        Schema schema158 = builder.addSchema(3078, V3078::new);
        builder.addFixer(new AddNewChoices(schema158, "Added Frog", References.ENTITY));
        builder.addFixer(new AddNewChoices(schema158, "Added Tadpole", References.ENTITY));
        builder.addFixer(new AddNewChoices(schema158, "Added Sculk Shrieker", References.BLOCK_ENTITY));
        Schema schema159 = builder.addSchema(3081, V3081::new);
        builder.addFixer(new AddNewChoices(schema159, "Added Warden", References.ENTITY));
        Schema schema160 = builder.addSchema(3082, V3082::new);
        builder.addFixer(new AddNewChoices(schema160, "Added Chest Boat", References.ENTITY));
        Schema schema161 = builder.addSchema(3083, V3083::new);
        builder.addFixer(new AddNewChoices(schema161, "Added Allay", References.ENTITY));
        Schema schema162 = builder.addSchema(3084, SAME_NAMESPACED);
        builder.addFixer(
            new NamespacedTypeRenameFix(
                schema162,
        ...
        Schema schema163 = builder.addSchema(3086, SAME_NAMESPACED);
        builder.addFixer(
            new EntityVariantFix(
                schema163, "Change cat variant type", References.ENTITY, "minecraft:cat", "CatType", Util.make(new Int2ObjectOpenHashMap<String>(), p_216528_ -> {
        ...
        Schema schema164 = builder.addSchema(3087, SAME_NAMESPACED);
        builder.addFixer(
            new EntityVariantFix(
                schema164, "Change frog variant type", References.ENTITY, "minecraft:frog", "Variant", Util.make(new Int2ObjectOpenHashMap<String>(), p_216519_ -> {
        ...
        Schema schema165 = builder.addSchema(3090, SAME_NAMESPACED);
        builder.addFixer(
            new EntityFieldsRenameFix(schema165, "EntityPaintingFieldsRenameFix", "minecraft:painting", Map.of("Motive", "variant", "Facing", "facing"))
        );
        Schema schema166 = builder.addSchema(3093, SAME_NAMESPACED);
        builder.addFixer(new EntityGoatMissingStateFix(schema166));
        Schema schema167 = builder.addSchema(3094, SAME_NAMESPACED);
        builder.addFixer(new GoatHornIdFix(schema167));
        Schema schema168 = builder.addSchema(3097, SAME_NAMESPACED);
        ...
        Schema schema169 = builder.addSchema(3108, SAME_NAMESPACED);
        builder.addFixer(new BlendingDataRemoveFromNetherEndFix(schema169));
        Schema schema170 = builder.addSchema(3201, SAME_NAMESPACED);
        ...
        Schema schema174 = builder.addSchema(3209, SAME_NAMESPACED);
        builder.addFixer(new ItemStackSpawnEggFix(schema174, false, "minecraft:pig_spawn_egg"));
        Schema schema175 = builder.addSchema(3214, SAME_NAMESPACED);
        builder.addFixer(new OptionsAmbientOcclusionFix(schema175));
        Schema schema176 = builder.addSchema(3319, SAME_NAMESPACED);
        builder.addFixer(new OptionsAccessibilityOnboardFix(schema176));
        Schema schema177 = builder.addSchema(3322, SAME_NAMESPACED);
        builder.addFixer(new EffectDurationFix(schema177));
        Schema schema178 = builder.addSchema(3325, V3325::new);
        builder.addFixer(new AddNewChoices(schema178, "Added displays", References.ENTITY));
        Schema schema179 = builder.addSchema(3326, V3326::new);
        builder.addFixer(new AddNewChoices(schema179, "Added Sniffer", References.ENTITY));
        Schema schema180 = builder.addSchema(3327, V3327::new);
        builder.addFixer(new AddNewChoices(schema180, "Archaeology", References.BLOCK_ENTITY));
        Schema schema181 = builder.addSchema(3328, V3328::new);
        builder.addFixer(new AddNewChoices(schema181, "Added interaction", References.ENTITY));
        Schema schema182 = builder.addSchema(3438, V3438::new);
        builder.addFixer(
        ...
        builder.addFixer(new AddNewChoices(schema182, "Added calibrated sculk sensor", References.BLOCK_ENTITY));
        Schema schema183 = builder.addSchema(3439, V3439::new);
        builder.addFixer(new BlockEntitySignDoubleSidedEditableTextFix(schema183, "Updated sign text format for Signs", "minecraft:sign"));
        Schema schema184 = builder.addSchema(3439, 1, V3439_1::new);
        builder.addFixer(new BlockEntitySignDoubleSidedEditableTextFix(schema184, "Updated sign text format for Hanging Signs", "minecraft:hanging_sign"));
        Schema schema185 = builder.addSchema(3440, SAME_NAMESPACED);
        builder.addFixer(
            new NamespacedTypeRenameFix(
                schema185,
        ...
        builder.addFixer(new FeatureFlagRemoveFix(schema185, "Remove 1.20 feature toggle", Set.of("minecraft:update_1_20")));
        Schema schema186 = builder.addSchema(3447, SAME_NAMESPACED);
        builder.addFixer(
            ItemRenameFix.create(
                schema186,
        ...
        Schema schema187 = builder.addSchema(3448, V3448::new);
        builder.addFixer(new DecoratedPotFieldRenameFix(schema187));
        Schema schema188 = builder.addSchema(3450, SAME_NAMESPACED);
        builder.addFixer(
        ...
        Schema schema189 = builder.addSchema(3451, SAME_NAMESPACED);
        builder.addFixer(new ChunkDeleteLightFix(schema189));
        Schema schema190 = builder.addSchema(3459, SAME_NAMESPACED);
        builder.addFixer(new LegacyDragonFightFix(schema190));
        Schema schema191 = builder.addSchema(3564, SAME_NAMESPACED);
        builder.addFixer(new DropInvalidSignDataFix(schema191, "minecraft:sign"));
        Schema schema192 = builder.addSchema(3564, 1, SAME_NAMESPACED);
        builder.addFixer(new DropInvalidSignDataFix(schema192, "minecraft:hanging_sign"));
        Schema schema193 = builder.addSchema(3565, SAME_NAMESPACED);
        builder.addFixer(new RandomSequenceSettingsFix(schema193));
        Schema schema194 = builder.addSchema(3566, SAME_NAMESPACED);
        builder.addFixer(new ScoreboardDisplaySlotFix(schema194));
        Schema schema195 = builder.addSchema(3568, SAME_NAMESPACED);
        builder.addFixer(new MobEffectIdFix(schema195));
        Schema schema196 = builder.addSchema(3682, V3682::new);
        builder.addFixer(new AddNewChoices(schema196, "Added Crafter", References.BLOCK_ENTITY));
        Schema schema197 = builder.addSchema(3683, V3683::new);
        builder.addFixer(new PrimedTntBlockStateFixer(schema197));
        Schema schema198 = builder.addSchema(3685, V3685::new);
        builder.addFixer(new FixProjectileStoredItem(schema198));
        Schema schema199 = builder.addSchema(3689, V3689::new);
        builder.addFixer(new AddNewChoices(schema199, "Added Breeze", References.ENTITY));
        builder.addFixer(new AddNewChoices(schema199, "Added Trial Spawner", References.BLOCK_ENTITY));
        Schema schema200 = builder.addSchema(3692, SAME_NAMESPACED);
        UnaryOperator<String> unaryoperator1 = createRenamer(Map.of("minecraft:grass", "minecraft:short_grass"));
        builder.addFixer(BlockRenameFix.create(schema200, "Rename grass block to short_grass", unaryoperator1));
        builder.addFixer(ItemRenameFix.create(schema200, "Rename grass item to short_grass", unaryoperator1));
        Schema schema201 = builder.addSchema(3799, V3799::new);
        builder.addFixer(new AddNewChoices(schema201, "Added Armadillo", References.ENTITY));
        Schema schema202 = builder.addSchema(3800, SAME_NAMESPACED);
        UnaryOperator<String> unaryoperator2 = createRenamer(Map.of("minecraft:scute", "minecraft:turtle_scute"));
        builder.addFixer(ItemRenameFix.create(schema202, "Rename scute item to turtle_scute", unaryoperator2));
        ...
        Schema schema203 = builder.addSchema(3803, SAME_NAMESPACED);
        builder.addFixer(
        ...
        Schema schema204 = builder.addSchema(3807, V3807::new);
        builder.addFixer(new AddNewChoices(schema204, "Added Vault", References.BLOCK_ENTITY));
        Schema schema205 = builder.addSchema(3807, 1, SAME_NAMESPACED);
        builder.addFixer(new MapBannerBlockPosFormatFix(schema205));
        Schema schema206 = builder.addSchema(3808, V3808::new);
        builder.addFixer(new HorseBodyArmorItemFix(schema206, "minecraft:horse", "ArmorItem", true));
        Schema schema207 = builder.addSchema(3808, 1, V3808_1::new);
        builder.addFixer(new HorseBodyArmorItemFix(schema207, "minecraft:llama", "DecorItem", false));
        Schema schema208 = builder.addSchema(3808, 2, V3808_2::new);
        builder.addFixer(new HorseBodyArmorItemFix(schema208, "minecraft:trader_llama", "DecorItem", false));
        Schema schema209 = builder.addSchema(3809, SAME_NAMESPACED);
        builder.addFixer(new ChestedHorsesInventoryZeroIndexingFix(schema209));
        Schema schema210 = builder.addSchema(3812, SAME_NAMESPACED);
        builder.addFixer(new FixWolfHealth(schema210));
        Schema schema211 = builder.addSchema(3813, V3813::new);
        builder.addFixer(new BlockPosFormatAndRenamesFix(schema211));
        Schema schema212 = builder.addSchema(3814, SAME_NAMESPACED);
        builder.addFixer(
            new AttributesRenameLegacy(
        ...
        Schema schema213 = builder.addSchema(3816, V3816::new);
        builder.addFixer(new AddNewChoices(schema213, "Added Bogged", References.ENTITY));
        Schema schema214 = builder.addSchema(3818, V3818::new);
        builder.addFixer(new BeehiveFieldRenameFix(schema214));
        builder.addFixer(new EmptyItemInHotbarFix(schema214));
        Schema schema215 = builder.addSchema(3818, 1, SAME_NAMESPACED);
        builder.addFixer(new BannerPatternFormatFix(schema215));
        Schema schema216 = builder.addSchema(3818, 2, SAME_NAMESPACED);
        builder.addFixer(new TippedArrowPotionToItemFix(schema216));
        Schema schema217 = builder.addSchema(3818, 3, V3818_3::new);
        builder.addFixer(new WriteAndReadFix(schema217, "Inject data component types", References.DATA_COMPONENTS));
        Schema schema218 = builder.addSchema(3818, 4, V3818_4::new);
        builder.addFixer(new ParticleUnflatteningFix(schema218));
        Schema schema219 = builder.addSchema(3818, 5, V3818_5::new);
        builder.addFixer(new ItemStackComponentizationFix(schema219));
        Schema schema220 = builder.addSchema(3818, 6, SAME_NAMESPACED);
        builder.addFixer(new AreaEffectCloudPotionFix(schema220));
        Schema schema221 = builder.addSchema(3820, SAME_NAMESPACED);
        builder.addFixer(new PlayerHeadBlockProfileFix(schema221));
        builder.addFixer(new LodestoneCompassComponentFix(schema221));
        Schema schema222 = builder.addSchema(3825, V3825::new);
        builder.addFixer(new ItemStackCustomNameToOverrideComponentFix(schema222));
        builder.addFixer(new BannerEntityCustomNameToOverrideComponentFix(schema222));
        builder.addFixer(new TrialSpawnerConfigFix(schema222));
        builder.addFixer(new AddNewChoices(schema222, "Added Ominous Item Spawner", References.ENTITY));
        Schema schema223 = builder.addSchema(3828, SAME_NAMESPACED);
        builder.addFixer(new EmptyItemInVillagerTradeFix(schema223));
        Schema schema224 = builder.addSchema(3833, SAME_NAMESPACED);
        builder.addFixer(new RemoveEmptyItemInBrushableBlockFix(schema224));
        Schema schema225 = builder.addSchema(3938, V3938::new);
        builder.addFixer(new ProjectileStoredWeaponFix(schema225));
        Schema schema226 = builder.addSchema(3939, SAME_NAMESPACED);
        builder.addFixer(new FeatureFlagRemoveFix(schema226, "Remove 1.21 feature toggle", Set.of("minecraft:update_1_21")));
        Schema schema227 = builder.addSchema(3943, SAME_NAMESPACED);
        builder.addFixer(new OptionsMenuBlurrinessFix(schema227));
        Schema schema228 = builder.addSchema(3945, SAME_NAMESPACED);
        builder.addFixer(new AttributeModifierIdFix(schema228));
        builder.addFixer(new JukeboxTicksSinceSongStartedFix(schema228));
        Schema schema229 = builder.addSchema(4054, SAME_NAMESPACED);
        builder.addFixer(new OminousBannerRarityFix(schema229));
        Schema schema230 = builder.addSchema(4055, SAME_NAMESPACED);
        builder.addFixer(new AttributeIdPrefixFix(schema230));
        Schema schema231 = builder.addSchema(4057, SAME_NAMESPACED);
        builder.addFixer(new CarvingStepRemoveFix(schema231));
        Schema schema232 = builder.addSchema(4059, V4059::new);
        builder.addFixer(new FoodToConsumableFix(schema232));
        Schema schema233 = builder.addSchema(4061, SAME_NAMESPACED);
        builder.addFixer(new TrialSpawnerConfigInRegistryFix(schema233));
        Schema schema234 = builder.addSchema(4064, SAME_NAMESPACED);
        builder.addFixer(new FireResistantToDamageResistantComponentFix(schema234));
        Schema schema235 = builder.addSchema(4067, V4067::new);
        builder.addFixer(new BoatSplitFix(schema235));
        builder.addFixer(new FeatureFlagRemoveFix(schema235, "Remove Bundle experimental feature flag", Set.of("minecraft:bundle")));
        Schema schema236 = builder.addSchema(4068, SAME_NAMESPACED);
        builder.addFixer(new LockComponentPredicateFix(schema236));
        builder.addFixer(new ContainerBlockEntityLockPredicateFix(schema236));
        Schema schema237 = builder.addSchema(4070, V4070::new);
        builder.addFixer(new AddNewChoices(schema237, "Added Pale Oak Boat and Pale Oak Chest Boat", References.ENTITY));
        Schema schema238 = builder.addSchema(4071, V4071::new);
        builder.addFixer(new AddNewChoices(schema238, "Added Creaking", References.ENTITY));
        builder.addFixer(new AddNewChoices(schema238, "Added Creaking Heart", References.BLOCK_ENTITY));
        Schema schema239 = builder.addSchema(4081, SAME_NAMESPACED);
        builder.addFixer(new EntitySalmonSizeFix(schema239));
        Schema schema240 = builder.addSchema(4173, SAME_NAMESPACED);
        builder.addFixer(new EntityFieldsRenameFix(schema240, "Rename TNT Minecart fuse", "minecraft:tnt_minecart", Map.of("TNTFuse", "fuse")));
        Schema schema241 = builder.addSchema(4175, SAME_NAMESPACED);
        builder.addFixer(new EquippableAssetRenameFix(schema241));
        builder.addFixer(new CustomModelDataExpandFix(schema241));
        Schema schema242 = builder.addSchema(4176, SAME_NAMESPACED);
        builder.addFixer(new InvalidBlockEntityLockFix(schema242));
        builder.addFixer(new InvalidLockComponentFix(schema242));
        Schema schema243 = builder.addSchema(4180, SAME_NAMESPACED);
        builder.addFixer(new FeatureFlagRemoveFix(schema243, "Remove Winter Drop toggle", Set.of("minecraft:winter_drop")));
        Schema schema244 = builder.addSchema(4181, SAME_NAMESPACED);
        builder.addFixer(new BlockEntityFurnaceBurnTimeFix(schema244, "minecraft:furnace"));
        builder.addFixer(new BlockEntityFurnaceBurnTimeFix(schema244, "minecraft:smoker"));
        builder.addFixer(new BlockEntityFurnaceBurnTimeFix(schema244, "minecraft:blast_furnace"));
        Schema schema245 = builder.addSchema(4187, SAME_NAMESPACED);
        builder.addFixer(
            new EntityAttributeBaseValueFix(
                schema245, "Villager follow range fix undo", "minecraft:villager", "minecraft:follow_range", p_390638_ -> p_390638_ == 48.0 ? 16.0 : p_390638_
            )
        );
        builder.addFixer(
            new EntityAttributeBaseValueFix(
                schema245, "Bee follow range fix", "minecraft:bee", "minecraft:follow_range", p_390639_ -> p_390639_ == 48.0 ? 16.0 : p_390639_
            )
        );
        builder.addFixer(
            new EntityAttributeBaseValueFix(
                schema245, "Allay follow range fix", "minecraft:allay", "minecraft:follow_range", p_390635_ -> p_390635_ == 48.0 ? 16.0 : p_390635_
            )
        );
        builder.addFixer(
            new EntityAttributeBaseValueFix(
                schema245, "Llama follow range fix", "minecraft:llama", "minecraft:follow_range", p_390636_ -> p_390636_ == 40.0 ? 16.0 : p_390636_
            )
        );
        builder.addFixer(
            new EntityAttributeBaseValueFix(
        ...
        builder.addFixer(
            new EntityAttributeBaseValueFix(
                schema245, "Warden follow range fix", "minecraft:warden", "minecraft:follow_range", p_390637_ -> p_390637_ == 16.0 ? 24.0 : p_390637_
            )
        );
        Schema schema246 = builder.addSchema(4290, V4290::new);
        builder.addFixer(new UnflattenTextComponentFix(schema246));
        Schema schema247 = builder.addSchema(4291, SAME_NAMESPACED);
        builder.addFixer(new LegacyHoverEventFix(schema247));
        builder.addFixer(new TextComponentStringifiedFlagsFix(schema247));
        Schema schema248 = builder.addSchema(4292, V4292::new);
        builder.addFixer(new TextComponentHoverAndClickEventFix(schema248));
        Schema schema249 = builder.addSchema(4293, SAME_NAMESPACED);
        builder.addFixer(new DropChancesFormatFix(schema249));
        Schema schema250 = builder.addSchema(4294, SAME_NAMESPACED);
        builder.addFixer(
        ...
        Schema schema251 = builder.addSchema(4295, SAME_NAMESPACED);
        builder.addFixer(new BlendingDataFix(schema251));
        Schema schema252 = builder.addSchema(4296, SAME_NAMESPACED);
        builder.addFixer(new AreaEffectCloudDurationScaleFix(schema252));
        Schema schema253 = builder.addSchema(4297, SAME_NAMESPACED);
        builder.addFixer(new ForcedChunkToTicketFix(schema253));
        Schema schema254 = builder.addSchema(4299, SAME_NAMESPACED);
        builder.addFixer(new EntitySpawnerItemVariantComponentFix(schema254));
        Schema schema255 = builder.addSchema(4300, V4300::new);
        builder.addFixer(new SaddleEquipmentSlotFix(schema255));
        Schema schema256 = builder.addSchema(4301, V4301::new);
        builder.addFixer(new EquipmentFormatFix(schema256));
        Schema schema257 = builder.addSchema(4302, V4302::new);
        builder.addFixer(new AddNewChoices(schema257, "Added Test and Test Instance Block Entities", References.BLOCK_ENTITY));
        Schema schema258 = builder.addSchema(4303, SAME_NAMESPACED);
        builder.addFixer(new EntityFallDistanceFloatToDoubleFix(schema258, References.ENTITY));
        builder.addFixer(new EntityFallDistanceFloatToDoubleFix(schema258, References.PLAYER));
        Schema schema259 = builder.addSchema(4305, SAME_NAMESPACED);
        builder.addFixer(
            new BlockPropertyRenameAndFix(schema259, "rename test block mode", "minecraft:test_block", "test_block_mode", "mode", p_399404_ -> p_399404_)
        );
        Schema schema260 = builder.addSchema(4306, V4306::new);
        builder.addFixer(new ThrownPotionSplitFix(schema260));
        Schema schema261 = builder.addSchema(4307, V4307::new);
        builder.addFixer(new TooltipDisplayComponentFix(schema261));
        Schema schema262 = builder.addSchema(4309, SAME_NAMESPACED);
        builder.addFixer(new RaidRenamesDataFix(schema262));
        builder.addFixer(new ChunkTicketUnpackPosFix(schema262));
        Schema schema263 = builder.addSchema(4311, SAME_NAMESPACED);
        builder.addFixer(
            new AdvancementsRenameFix(
        ...
        Schema schema264 = builder.addSchema(4312, V4312::new);
        builder.addFixer(new PlayerEquipmentFix(schema264));
        Schema schema265 = builder.addSchema(4314, SAME_NAMESPACED);
        builder.addFixer(new InlineBlockPosFormatFix(schema265));
        Schema schema266 = builder.addSchema(4420, V4420::new);
        builder.addFixer(new NamedEntityConvertUncheckedFix(schema266, "AreaEffectCloudCustomParticleFix", References.ENTITY, "minecraft:area_effect_cloud"));
        Schema schema267 = builder.addSchema(4421, V4421::new);
        builder.addFixer(new AddNewChoices(schema267, "Added Happy Ghast", References.ENTITY));
        Schema schema268 = builder.addSchema(4424, SAME_NAMESPACED);
        builder.addFixer(new FeatureFlagRemoveFix(schema268, "Remove Locator Bar experimental feature flag", Set.of("minecraft:locator_bar")));
        builder.addFixer(new AddFieldFix(schema268, References.PLAYER, "style", p_442437_ -> p_442437_.createString("minecraft:default"), "locator_bar_icon"));
        builder.addFixer(new AddFieldFix(schema268, References.ENTITY, "style", p_442438_ -> p_442438_.createString("minecraft:default"), "locator_bar_icon"));
        Schema schema269 = builder.addSchema(4531, V4531::new);
        builder.addFixer(new AddNewChoices(schema269, "Added Copper Golem", References.ENTITY));
        Schema schema270 = builder.addSchema(4532, V4532::new);
        builder.addFixer(new AddNewChoices(schema270, "Added Copper Golem Statue Block Entity", References.BLOCK_ENTITY));
        Schema schema271 = builder.addSchema(4533, V4533::new);
        builder.addFixer(new AddNewChoices(schema271, "Added Shelf", References.BLOCK_ENTITY));
        Schema schema272 = builder.addSchema(4535, SAME_NAMESPACED);
        builder.addFixer(new CopperGolemWeatherStateFix(schema272));
        Schema schema273 = builder.addSchema(4537, SAME_NAMESPACED);
        builder.addFixer(new ChunkDeleteLightFix(schema273));
        Schema schema274 = builder.addSchema(4541, SAME_NAMESPACED);
        builder.addFixer(BlockRenameFix.create(schema274, "Rename chain to iron_chain", createRenamer("minecraft:chain", "minecraft:iron_chain")));
        builder.addFixer(ItemRenameFix.create(schema274, "Rename chain to iron_chain", createRenamer("minecraft:chain", "minecraft:iron_chain")));
        Schema schema275 = builder.addSchema(4543, V4543::new);
        builder.addFixer(new AddNewChoices(schema275, "Added Mannequin", References.ENTITY));
        Schema schema276 = builder.addSchema(4544, SAME_NAMESPACED);
        builder.addFixer(new LegacyWorldBorderFix(schema276));
        Schema schema277 = builder.addSchema(4548, SAME_NAMESPACED);
        builder.addFixer(new WorldSpawnDataFix(schema277));
        builder.addFixer(new PlayerRespawnDataFix(schema277));
    }
