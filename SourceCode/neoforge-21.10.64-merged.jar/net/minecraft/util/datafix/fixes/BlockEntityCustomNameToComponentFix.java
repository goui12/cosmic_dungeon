...
public class BlockEntityCustomNameToComponentFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped(
            ...
            type1,
            p_392814_ -> {
                Optional<String> optional = p_392814_.getOptional(opticfinder);
                return optional.isPresent() && !NAMEABLE_BLOCK_ENTITIES.contains(optional.get())
                    ? ExtraDataFixUtils.cast(type1, p_392814_)
                    : Util.writeAndReadTypedOrThrow(ExtraDataFixUtils.cast(type2, p_392814_), type1, BlockEntityCustomNameToComponentFix::fixTagCustomName);
            }
        );
    }
