...
public class RaidRenamesDataFix extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        return this.fixTypeEverywhereTyped(
            ...
            p_401304_ -> p_401304_.update(DSL.remainderFinder(), p_401339_ -> p_401339_.update("data", RaidRenamesDataFix::fix))
        );
    }

    private static Dynamic<?> fix(Dynamic<?> data) {
        return data.renameAndFixField("Raids", "raids", p_401070_ -> p_401070_.createList(p_401070_.asStream().map(RaidRenamesDataFix::fixRaid)))
