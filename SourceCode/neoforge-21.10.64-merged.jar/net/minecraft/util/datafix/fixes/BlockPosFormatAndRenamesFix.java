    ...
    public TypeRewriteRule makeRule() {
        ...
        list.add(
            this.writeFixAndRead(
                ...
                p_326364_ -> p_326364_.update("data", this::fixMapSavedData)
            )
        );
        ...
        list.add(
            this.fixTypeEverywhereTyped(
                ...
                ItemStackTagFix.createFixer(
                    ...
                    p_392815_ -> p_392815_.update(DSL.remainderFinder(), p_326048_ -> p_326048_.update("LodestonePos", ExtraDataFixUtils::fixBlockPos))
                )
            )
        );
