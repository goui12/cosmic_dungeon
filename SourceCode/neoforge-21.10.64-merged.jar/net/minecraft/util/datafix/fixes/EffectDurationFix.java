...
public class EffectDurationFix extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        return TypeRewriteRule.seq(
            ...
            this.fixTypeEverywhereTyped("EffectDurationItem", type, p_379071_ -> {
                if (p_379071_.getOptional(opticfinder).filter(p_379072_ -> POTION_ITEMS.contains(p_379072_.getSecond())).isPresent()) {
                    Optional<? extends Typed<?>> optional = p_379071_.getOptionalTyped(opticfinder1);
                    if (optional.isPresent()) {
                        ...
                        return p_379071_.set(opticfinder1, typed);
                    }
                }
