...
public record Advancement(
    ...
    public void validate(ProblemReporter reporter, HolderGetter.Provider lootData) {
        this.criteria.forEach((p_421271_, p_421272_) -> {
            CriterionValidator criterionvalidator = new CriterionValidator(reporter.forChild(new ProblemReporter.RootFieldPathElement(p_421271_)), lootData);
            p_421272_.triggerInstance().validate(criterionvalidator);
        });
    }
