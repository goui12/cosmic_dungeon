...
public class CreakingAi {
    ...
    static void initFightActivity(Creaking creaking, Brain<Creaking> brain) {
        brain.addActivityWithConditions(
            ...
            ImmutableList.of(
                ...
                StopAttackingIfTargetInvalid.create((p_396838_, p_396839_) -> !isAttackTargetStillReachable(creaking, p_396839_))
            ),
    ...
    private static boolean isAttackTargetStillReachable(Creaking creaking, LivingEntity target) {
        ...
        return optional.<Boolean>map(p_396836_ -> target instanceof Player player && p_396836_.contains(player)).orElse(false);
    }
