...
public class Drowned extends Zombie implements RangedAttackMob {
    ...
    protected void addBehaviourGoals() {
        ...
        this.targetSelector
            .addGoal(2, new NearestAttackableTargetGoal<>(this, Player.class, 10, true, false, (p_376613_, p_376137_) -> this.okTarget(p_376613_)));
    ...
    protected boolean canReplaceCurrentItem(ItemStack newItem, ItemStack currentItem, EquipmentSlot slot) {
        return currentItem.is(Items.NAUTILUS_SHELL) ? false : super.canReplaceCurrentItem(newItem, currentItem, slot);
    }
