...
public class CaveSpider extends Spider {
    ...
    public SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_32259_, DifficultyInstance p_32260_, EntitySpawnReason p_363852_, @Nullable SpawnGroupData p_32262_
    ) {
        return p_32262_;
    }
    ...
    public Vec3 getVehicleAttachmentPoint(Entity p_316479_) {
        return p_316479_.getBbWidth() <= this.getBbWidth() ? new Vec3(0.0, 0.21875 * this.getScale(), 0.0) : super.getVehicleAttachmentPoint(p_316479_);
    }
}
