...
public record Input(boolean forward, boolean backward, boolean left, boolean right, boolean jump, boolean shift, boolean sprint) {
    ...
    public static final StreamCodec<FriendlyByteBuf, Input> STREAM_CODEC = new StreamCodec<FriendlyByteBuf, Input>() {
        public void encode(FriendlyByteBuf p_371304_, Input p_371322_) {
            byte b0 = 0;
            b0 = (byte)(b0 | (p_371322_.forward() ? 1 : 0));
            b0 = (byte)(b0 | (p_371322_.backward() ? 2 : 0));
            b0 = (byte)(b0 | (p_371322_.left() ? 4 : 0));
            b0 = (byte)(b0 | (p_371322_.right() ? 8 : 0));
            b0 = (byte)(b0 | (p_371322_.jump() ? 16 : 0));
            b0 = (byte)(b0 | (p_371322_.shift() ? 32 : 0));
            b0 = (byte)(b0 | (p_371322_.sprint() ? 64 : 0));
            p_371304_.writeByte(b0);
        }

        public Input decode(FriendlyByteBuf p_371783_) {
            byte b0 = p_371783_.readByte();
            boolean flag = (b0 & 1) != 0;
