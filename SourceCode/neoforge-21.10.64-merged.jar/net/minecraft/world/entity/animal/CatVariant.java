...
public record CatVariant(ClientAsset.ResourceTexture assetInfo, SpawnPrioritySelectors spawnConditions)
    ...
    public static final Codec<CatVariant> DIRECT_CODEC = RecordCodecBuilder.create(
        p_450876_ -> p_450876_.group(
            ...
            .apply(p_450876_, CatVariant::new)
    );
    public static final Codec<CatVariant> NETWORK_CODEC = RecordCodecBuilder.create(
        p_450877_ -> p_450877_.group(ClientAsset.ResourceTexture.DEFAULT_FIELD_CODEC.forGetter(CatVariant::assetInfo)).apply(p_450877_, CatVariant::new)
    );
    ...
    private CatVariant(ClientAsset.ResourceTexture p_451354_) {
        this(p_451354_, SpawnPrioritySelectors.EMPTY);
    }
