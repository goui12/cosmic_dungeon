...
public class Allay extends PathfinderMob implements InventoryCarrier, VibrationSystem {
    ...
    public boolean hurtServer(ServerLevel level, DamageSource damageSource, float amount) {
        return this.isLikedPlayer(damageSource.getEntity()) ? false : super.hurtServer(level, damageSource, amount);
    }
    ...
    protected void dropEquipment(ServerLevel level) {
        ...
        this.inventory.removeAllItems().forEach(p_375836_ -> this.spawnAtLocation(level, p_375836_));
