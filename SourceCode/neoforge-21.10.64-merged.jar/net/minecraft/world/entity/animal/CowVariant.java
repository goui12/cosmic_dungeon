...
public record CowVariant(ModelAndTexture<CowVariant.ModelType> modelAndTexture, SpawnPrioritySelectors spawnConditions)
    ...
    public static final Codec<CowVariant> DIRECT_CODEC = RecordCodecBuilder.create(
        p_401151_ -> p_401151_.group(
            ...
            .apply(p_401151_, CowVariant::new)
    );
    public static final Codec<CowVariant> NETWORK_CODEC = RecordCodecBuilder.create(
        p_401154_ -> p_401154_.group(ModelAndTexture.codec(CowVariant.ModelType.CODEC, CowVariant.ModelType.NORMAL).forGetter(CowVariant::modelAndTexture))
            .apply(p_401154_, CowVariant::new)
    );
    ...
    private CowVariant(ModelAndTexture<CowVariant.ModelType> p_401192_) {
        this(p_401192_, SpawnPrioritySelectors.EMPTY);
    }
