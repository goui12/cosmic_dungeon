...
public record FrogVariant(ClientAsset.ResourceTexture assetInfo, SpawnPrioritySelectors spawnConditions)
    ...
    public static final Codec<FrogVariant> DIRECT_CODEC = RecordCodecBuilder.create(
        p_450879_ -> p_450879_.group(
            ...
            .apply(p_450879_, FrogVariant::new)
    );
    public static final Codec<FrogVariant> NETWORK_CODEC = RecordCodecBuilder.create(
        p_450878_ -> p_450878_.group(ClientAsset.ResourceTexture.DEFAULT_FIELD_CODEC.forGetter(FrogVariant::assetInfo)).apply(p_450878_, FrogVariant::new)
    );
    ...
    private FrogVariant(ClientAsset.ResourceTexture p_451378_) {
        this(p_451378_, SpawnPrioritySelectors.EMPTY);
    }
