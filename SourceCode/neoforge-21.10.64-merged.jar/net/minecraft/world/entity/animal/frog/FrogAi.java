            ...
            ImmutableList.of(
                ...
                Pair.of(
                    ...
                    StartAttacking.create(
                        (p_375840_, p_375841_) -> canAttack(p_375841_),
                        (p_376533_, p_218605_) -> p_218605_.getBrain().getMemory(MemoryModuleType.NEAREST_ATTACKABLE)
                    )
                ),
        ...
        brain.addActivityWithConditions(
            ...
            ImmutableList.of(
                ...
                Pair.of(
                    2,
                    StartAttacking.create(
                        (p_375838_, p_375839_) -> canAttack(p_375839_),
                        (p_376814_, p_218601_) -> p_218601_.getBrain().getMemory(MemoryModuleType.NEAREST_ATTACKABLE)
                    )
                ),
        ...
        brain.addActivityWithConditions(
            ...
            ImmutableList.of(
                ...
                Pair.of(
                    1,
                    StartAttacking.create(
                        (p_375842_, p_375843_) -> canAttack(p_375843_),
                        (p_376633_, p_218597_) -> p_218597_.getBrain().getMemory(MemoryModuleType.NEAREST_ATTACKABLE)
                    )
                ),
