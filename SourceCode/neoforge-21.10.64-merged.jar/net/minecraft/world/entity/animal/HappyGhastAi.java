...
public class HappyGhastAi {
    ...
    private static void initIdleActivity(Brain<HappyGhast> brain) {
        brain.addActivity(
            Activity.IDLE,
            ImmutableList.of(
                Pair.of(1, new FollowTemptation(p_415650_ -> 1.25F, p_416108_ -> 3.0, true)),
                Pair.of(2, BabyFollowAdult.create(ADULT_FOLLOW_RANGE, p_415714_ -> 1.1F, MemoryModuleType.NEAREST_VISIBLE_PLAYER, true)),
                Pair.of(3, BabyFollowAdult.create(ADULT_FOLLOW_RANGE, p_416389_ -> 1.1F, MemoryModuleType.NEAREST_VISIBLE_ADULT, true)),
