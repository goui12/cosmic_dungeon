...
public class CowVariants {
    ...
    private static void register(
        ...
        register(context, key, modelType, assetId, SpawnPrioritySelectors.single(new BiomeCheck(holderset), 1));
    }
    ...
    private static void register(
        ...
        context.register(key, new CowVariant(new ModelAndTexture<>(modelType, resourcelocation), spawnConditions));
    }
}
