...
public class IronGolem extends AbstractGolem implements NeutralMob {
        ...
        this.targetSelector
            .addGoal(
                ...
                new NearestAttackableTargetGoal<>(
                    this, Mob.class, 5, false, false, (p_28879_, p_376412_) -> p_28879_ instanceof Enemy && !(p_28879_ instanceof Creeper)
                )
            );
    ...
    public boolean doHurtTarget(ServerLevel level, Entity source) {
        ...
        boolean flag = source.hurtServer(level, damagesource, f1);
        if (flag) {
            double d0 = source instanceof LivingEntity livingentity ? livingentity.getAttributeValue(Attributes.KNOCKBACK_RESISTANCE) : 0.0;
            double d1 = Math.max(0.0, 1.0 - d0);
            source.setDeltaMovement(source.getDeltaMovement().add(0.0, 0.4F * d1, 0.0));
