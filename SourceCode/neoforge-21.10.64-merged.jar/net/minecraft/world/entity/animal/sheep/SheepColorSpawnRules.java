...
public class SheepColorSpawnRules {
    ...
    public static DyeColor getSheepColor(Holder<Biome> biome, RandomSource random) {
        SheepColorSpawnRules.SheepColorSpawnConfiguration sheepcolorspawnrules$sheepcolorspawnconfiguration = getSheepColorConfiguration(biome);
        return sheepcolorspawnrules$sheepcolorspawnconfiguration.colors().get(random);
    }
    ...
    private static SheepColorSpawnRules.SheepColorProvider weighted(WeightedList<SheepColorSpawnRules.SheepColorProvider> colors) {
        if (colors.isEmpty()) {
            ...
            return p_404682_ -> colors.getRandomOrThrow(p_404682_).get(p_404682_);
        }
    }

    private static SheepColorSpawnRules.SheepColorProvider single(DyeColor color) {
        return p_405197_ -> color;
    }
