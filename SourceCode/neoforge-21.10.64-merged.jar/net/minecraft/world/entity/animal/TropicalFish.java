...
public class TropicalFish extends AbstractSchoolingFish {
    ...
    protected void readAdditionalSaveData(ValueInput input) {
        ...
        TropicalFish.Variant tropicalfish$variant = input.read("Variant", TropicalFish.Variant.CODEC).orElse(DEFAULT_VARIANT);
    ...
    public static enum Pattern implements StringRepresentable, TooltipProvider {
        ...
        public void addToTooltip(Item.TooltipContext context, Consumer<Component> tooltipAdder, TooltipFlag flag, DataComponentGetter componentGetter) {
            ...
            if (i != -1) {
                tooltipAdder.accept(Component.translatable(TropicalFish.getPredefinedName(i)).withStyle(achatformatting));
            } else {
                tooltipAdder.accept(this.displayName.plainCopy().withStyle(achatformatting));
