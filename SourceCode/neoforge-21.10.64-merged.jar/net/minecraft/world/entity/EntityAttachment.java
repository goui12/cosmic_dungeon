...
public enum EntityAttachment {
    ...
    public interface Fallback {
        ...
        EntityAttachment.Fallback AT_HEIGHT = (p_316259_, p_316219_) -> List.of(new Vec3(0.0, p_316219_, 0.0));
        EntityAttachment.Fallback AT_CENTER = (p_319580_, p_319581_) -> List.of(new Vec3(0.0, p_319581_ / 2.0, 0.0));
