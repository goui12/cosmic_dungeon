                            ...
                            if (optional.isEmpty()) {
                                ...
                                p_258916_.<List<LivingEntity>>get(p_258903_)
                                    ...
                                    .ifPresent(p_448959_ -> {
                                        ...
                                        p_258905_.erase();
                                        p_258901_.erase();
                                        if (p_448959_.getBrain().getMemory(MemoryModuleType.JOB_SITE).isEmpty()) {
                                            BehaviorUtils.setWalkAndLookTargetMemories(p_448959_, blockpos, speedModifier, 1);
                                            p_448959_.getBrain().setMemory(MemoryModuleType.POTENTIAL_JOB_SITE, GlobalPos.of(p_258912_.dimension(), blockpos));
