        ...
        return BehaviorBuilder.create(
            p_258371_ -> {
                ...
                return p_258371_.group(
                    ...
                    .apply(
                        p_258371_,
                        (p_258387_, p_258388_, p_258389_, p_258390_) -> (p_445322_, p_445323_, p_445324_) -> {
                            ItemEntity itementity = p_258371_.get(p_258389_);
                            if (p_258371_.tryGet(p_258390_).isEmpty()
                                && canWalkToItem.test(p_445323_)
                                && itementity.closerThan(p_445323_, maxDistToWalk)
                                && p_445323_.level().getWorldBorder().isWithinBounds(itementity.blockPosition())
                                && p_445323_.canPickUpLoot()) {
