...
public record Bees(List<BeehiveBlockEntity.Occupant> bees) implements TooltipProvider {
    ...
    @Override
    public void addToTooltip(Item.TooltipContext p_399955_, Consumer<Component> p_399845_, TooltipFlag p_400044_, DataComponentGetter p_400200_) {
        p_399845_.accept(Component.translatable("container.beehive.bees", this.bees.size(), 3).withStyle(ChatFormatting.GRAY));
    }
}
