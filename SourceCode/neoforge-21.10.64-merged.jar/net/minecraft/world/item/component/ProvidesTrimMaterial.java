...
public record ProvidesTrimMaterial(EitherHolder<TrimMaterial> material) {
    ...
    public ProvidesTrimMaterial(Holder<TrimMaterial> p_400173_) {
        this(new EitherHolder<>(p_400173_));
    }

    @Deprecated
    public ProvidesTrimMaterial(ResourceKey<TrimMaterial> p_399658_) {
        this(new EitherHolder<>(p_399658_));
    }
