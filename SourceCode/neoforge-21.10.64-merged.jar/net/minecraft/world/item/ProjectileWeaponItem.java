...
public abstract class ProjectileWeaponItem extends Item {
    ...
    protected static ItemStack useAmmo(ItemStack weapon, ItemStack ammo, LivingEntity shooter, boolean intangible) {
        ...
        int i = !intangible && shooter.level() instanceof ServerLevel serverlevel && !(shooter.hasInfiniteMaterials() || (ammo.getItem() instanceof ArrowItem ai && ai.isInfinite(ammo, weapon, shooter)))
