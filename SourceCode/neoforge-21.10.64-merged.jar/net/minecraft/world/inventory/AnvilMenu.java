...
public class AnvilMenu extends ItemCombinerMenu {
    ...
    protected void onTake(Player player, ItemStack stack) {
        ...
        var event = net.neoforged.neoforge.common.CommonHooks.fireAnvilCraftPre(this, player, stack, this.inputSlots.getItem(0), this.inputSlots.getItem(1));
        if (event.isCanceled()) {
            return;
        }
        ...
        net.neoforged.neoforge.common.CommonHooks.fireAnvilCraftPost(this, player, stack, leftInputSnapshot, rightInputSnapshot);
    }
