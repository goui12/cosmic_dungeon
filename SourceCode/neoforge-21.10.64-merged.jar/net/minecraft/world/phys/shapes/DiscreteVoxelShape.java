...
public abstract class DiscreteVoxelShape {
    ...
    public DiscreteVoxelShape rotate(OctahedralGroup octahedralGroup) {
        if (octahedralGroup == OctahedralGroup.IDENTITY) {
            ...
            Direction.Axis direction$axis = octahedralGroup.permute(Direction.Axis.X);
            Direction.Axis direction$axis1 = octahedralGroup.permute(Direction.Axis.Y);
            Direction.Axis direction$axis2 = octahedralGroup.permute(Direction.Axis.Z);
