...
public class CanyonWorldCarver extends WorldCarver<CanyonCarverConfiguration> {
    ...
    public boolean carve(
        ...
        int k = (int)(i * config.shape.distanceFactor.sample(random));
        int l = 0;
        this.doCarve(context, config, chunk, biomeAccessor, random.nextLong(), aquifer, d0, j, d1, f2, f, f1, 0, k, d2, carvingMask);
        return true;
    }
