...
public class StructureFeatureIndexSavedData extends SavedData {
    ...
    public static final Codec<StructureFeatureIndexSavedData> CODEC = RecordCodecBuilder.create(
        p_401392_ -> p_401392_.group(
                LONG_SET.fieldOf("All").forGetter(p_401027_ -> p_401027_.all), LONG_SET.fieldOf("Remaining").forGetter(p_401205_ -> p_401205_.remaining)
            )
            .apply(p_401392_, StructureFeatureIndexSavedData::new)
    );
