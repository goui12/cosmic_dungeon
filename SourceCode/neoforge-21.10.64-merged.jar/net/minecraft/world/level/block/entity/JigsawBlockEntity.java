...
public class JigsawBlockEntity extends BlockEntity {
    ...
    protected void saveAdditional(ValueOutput output) {
        ...
        output.store("name", ResourceLocation.CODEC, this.name);
        output.store("target", ResourceLocation.CODEC, this.target);
    ...
    protected void loadAdditional(ValueInput input) {
        ...
        this.name = input.read("name", ResourceLocation.CODEC).orElse(EMPTY_ID);
        this.target = input.read("target", ResourceLocation.CODEC).orElse(EMPTY_ID);
