...
public class SkullBlockEntity extends BlockEntity {
    ...
    protected void saveAdditional(ValueOutput output) {
        ...
        output.storeNullable("note_block_sound", ResourceLocation.CODEC, this.noteBlockSound);
    ...
    protected void loadAdditional(ValueInput input) {
        ...
        this.noteBlockSound = input.read("note_block_sound", ResourceLocation.CODEC).orElse(null);
