...
public class WaterlilyBlock extends VegetationBlock {
    ...
    @Override
    protected void entityInside(BlockState state, Level level, BlockPos pos, Entity entity, InsideBlockEffectApplier effectApplier, boolean p_451765_) {
        super.entityInside(state, level, pos, entity, effectApplier, p_451765_);
