...
public class SporeBlossomBlock extends Block {
    ...
    protected BlockState updateShape(
        ...
        LevelReader p_374047_,
        ScheduledTickAccess p_374543_,
        BlockPos p_154717_,
        Direction p_154714_,
        BlockPos p_154718_,
        BlockState p_154715_,
        RandomSource p_374461_
    ) {
        return p_154714_ == Direction.UP && !this.canSurvive(p_154713_, p_374047_, p_154717_)
            ? Blocks.AIR.defaultBlockState()
            : super.updateShape(p_154713_, p_374047_, p_374543_, p_154717_, p_154714_, p_154718_, p_154715_, p_374461_);
    }
