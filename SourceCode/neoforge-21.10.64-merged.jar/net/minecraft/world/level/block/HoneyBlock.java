...
public class HoneyBlock extends HalfTransparentBlock {
    ...
    @Override
    protected void entityInside(BlockState state, Level level, BlockPos pos, Entity entity, InsideBlockEffectApplier effectApplier, boolean p_451779_) {
        ...
        super.entityInside(state, level, pos, entity, effectApplier, p_451779_);
    }
