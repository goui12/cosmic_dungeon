...
public enum TestBlockMode implements StringRepresentable {
    ...
    private static final IntFunction<TestBlockMode> BY_ID = ByIdMap.continuous(p_397460_ -> p_397460_.id, values(), ByIdMap.OutOfBoundsStrategy.ZERO);
    public static final Codec<TestBlockMode> CODEC = StringRepresentable.fromEnum(TestBlockMode::values);
    public static final StreamCodec<ByteBuf, TestBlockMode> STREAM_CODEC = ByteBufCodecs.idMapper(BY_ID, p_397887_ -> p_397887_.id);
