...
public final class OverworldBiomeBuilder {
    ...
    private void addBottomBiome(
        ...
        consumer.accept(
            Pair.of(Climate.parameters(temperature, humidity, continentalness, erosion, Climate.Parameter.point(1.1F), depth, weirdness), key)
        );
    }
    ...
    public String getDebugStringForContinentalness(double continentalness) {
        double d0 = Climate.quantizeCoord((float)continentalness);
    ...
    private static String getDebugStringForNoiseValue(double depth, Climate.Parameter[] values) {
        double d0 = Climate.quantizeCoord((float)depth);
