...
public class BiomeManager {
    ...
    private static double getFiddledDistance(long seed, int x, int y, int z, double xNoise, double yNoise, double zNoise) {
        long $$7 = LinearCongruentialGenerator.next(seed, x);
        $$7 = LinearCongruentialGenerator.next($$7, y);
        $$7 = LinearCongruentialGenerator.next($$7, z);
        $$7 = LinearCongruentialGenerator.next($$7, x);
        $$7 = LinearCongruentialGenerator.next($$7, y);
        $$7 = LinearCongruentialGenerator.next($$7, z);
    ...
    private static double getFiddle(long seed) {
        double d0 = Math.floorMod(seed >> 24, 1024) / 1024.0;
        return (d0 - 0.5) * 0.9;
    }
