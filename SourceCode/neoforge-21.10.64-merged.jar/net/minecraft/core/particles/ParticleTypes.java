...
public class ParticleTypes {
    ...
    public static final ParticleType<TrailParticleOption> TRAIL = register(
        "trail", false, p_382559_ -> TrailParticleOption.CODEC, p_382560_ -> TrailParticleOption.STREAM_CODEC
    );
    ...
    private static <T extends ParticleOptions> ParticleType<T> register(
        ...
        return Registry.register(BuiltInRegistries.PARTICLE_TYPE, name, new ParticleType<T>(p_overrideLimiter) {
            @Override
